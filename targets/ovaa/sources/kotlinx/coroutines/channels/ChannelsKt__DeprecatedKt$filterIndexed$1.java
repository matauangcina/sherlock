...
@DebugMetadata(m22c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filterIndexed$1", m21f = "Deprecated.kt", m20i = {0, 0, 1, 1, 1, 2, 2}, m19l = {211, 212, 212}, m18m = "invokeSuspend", m17n = {"$this$produce", "index", "$this$produce", "e", "index", "$this$produce", "index"}, m16s = {"L$0", "I$0", "L$0", "L$2", "I$0", "L$0", "I$0"})
