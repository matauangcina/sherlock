...
@DebugMetadata(m22c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m21f = "Deprecated.kt", m20i = {0, 0, 1, 1}, m19l = {487, 242}, m18m = "filterNotNullTo", m17n = {"destination", "$this$consume$iv$iv", "destination", "$this$consume$iv$iv"}, m16s = {"L$0", "L$1", "L$0", "L$1"})
