...
@DebugMetadata(m22c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m21f = "Deprecated.kt", m20i = {0, 0, 0, 1, 1, 1, 1}, m19l = {434, 436}, m18m = "minWith", m17n = {"comparator", "$this$consume$iv", "iterator", "comparator", "$this$consume$iv", "iterator", "min"}, m16s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3"})
