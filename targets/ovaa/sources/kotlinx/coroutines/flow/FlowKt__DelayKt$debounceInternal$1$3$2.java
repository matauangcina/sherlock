...
@Metadata(m31d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u008a@"}, m30d2 = {"<anonymous>", "", "T", "value", "Lkotlinx/coroutines/channels/ChannelResult;", ""}, m29k = 3, m28mv = {1, 6, 0}, m26xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m22c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2", m21f = "Delay.kt", m20i = {0}, m19l = {243}, m18m = "invokeSuspend", m17n = {"$this$onFailure_u2dWpGqRn0$iv"}, m16s = {"L$0"})
...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1745invokeWpGqRn0(channelResult.m1734unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1745invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m1722boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m1734unboximpl = ((ChannelResult) this.L$0).m1734unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m1734unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m1734unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m1734unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m1726exceptionOrNullimpl(m1734unboximpl);
                    if (it != null) {
                        throw it;
                    }
