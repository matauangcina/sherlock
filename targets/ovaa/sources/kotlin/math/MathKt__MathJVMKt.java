...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m11ln(double x) {
        return Math.log(x);
    }
    ...
    /* renamed from: ln */
    private static final float m10ln(float x) {
