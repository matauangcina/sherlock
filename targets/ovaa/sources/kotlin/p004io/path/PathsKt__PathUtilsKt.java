...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getExtension(Path $this$extension) {
        ...
        return (fileName == null || (obj = fileName.toString()) == null || (substringAfterLast = StringsKt.substringAfterLast(obj, (char) FilenameUtils.EXTENSION_SEPARATOR, "")) == null) ? "" : substringAfterLast;
    }
