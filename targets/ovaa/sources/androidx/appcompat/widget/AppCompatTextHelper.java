...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0028R.styleable.AppCompatTextHelper, defStyleAttr, 0);
        TextView textView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0028R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int ap = a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableStart)) {
            this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableStart, 0));
        }
        if (a.hasValue(C0028R.styleable.AppCompatTextHelper_android_drawableEnd)) {
            this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0028R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
        }
        a.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0028R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0028R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0028R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (a2.hasValue(C0028R.styleable.TextAppearance_textLocale)) {
                localeListString = a2.getString(C0028R.styleable.TextAppearance_textLocale);
            }
            if (a2.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation = a2.getString(C0028R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attrs, C0028R.styleable.TextAppearance, defStyleAttr, 0);
        if (!hasPwdTm && a3.hasValue(C0028R.styleable.TextAppearance_textAllCaps)) {
            allCaps = a3.getBoolean(C0028R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        } else {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        }
        if (a3.hasValue(C0028R.styleable.TextAppearance_textLocale)) {
            localeListString = a3.getString(C0028R.styleable.TextAppearance_textLocale);
        }
        if (a3.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = a3.getString(C0028R.styleable.TextAppearance_fontVariationSettings);
        }
        if (a3.hasValue(C0028R.styleable.TextAppearance_android_textSize) && a3.getDimensionPixelSize(C0028R.styleable.TextAppearance_android_textSize, -1) == 0) {
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attrs, C0028R.styleable.AppCompatTextView);
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
            drawableLeft = drawableManager.getDrawable(context, drawableLeftId);
        }
        int drawableTopId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager.getDrawable(context, drawableTopId);
        }
        int drawableRightId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableRightCompat, -1);
        ...
        int drawableBottomId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        ...
        int drawableStartId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableStartCompat, -1);
        ...
        int drawableEndId = a4.getResourceId(C0028R.styleable.AppCompatTextView_drawableEndCompat, -1);
        ...
        if (a4.hasValue(C0028R.styleable.AppCompatTextView_drawableTint)) {
            ColorStateList tintList = a4.getColorStateList(C0028R.styleable.AppCompatTextView_drawableTint);
            TextViewCompat.setCompoundDrawableTintList(this.mView, tintList);
        }
        if (a4.hasValue(C0028R.styleable.AppCompatTextView_drawableTintMode)) {
            PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(a4.getInt(C0028R.styleable.AppCompatTextView_drawableTintMode, -1), null);
            TextViewCompat.setCompoundDrawableTintMode(this.mView, tintMode);
        }
        int firstBaselineToTopHeight = a4.getDimensionPixelSize(C0028R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a4.getDimensionPixelSize(C0028R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        int lineHeight = a4.getDimensionPixelSize(C0028R.styleable.AppCompatTextView_lineHeight, -1);
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0028R.styleable.TextAppearance_android_textStyle, this.mStyle);
        int i = a.getInt(C0028R.styleable.TextAppearance_android_textFontWeight, -1);
        this.mFontWeight = i;
        if (i != -1) {
            this.mStyle = (this.mStyle & 2) | 0;
        }
        if (a.hasValue(C0028R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0028R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            if (a.hasValue(C0028R.styleable.TextAppearance_fontFamily)) {
                fontFamilyId = C0028R.styleable.TextAppearance_fontFamily;
            } else {
                fontFamilyId = C0028R.styleable.TextAppearance_android_fontFamily;
            }
        ...
        } else if (a.hasValue(C0028R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = a.getInt(C0028R.styleable.TextAppearance_android_typeface, 1);
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0028R.styleable.TextAppearance);
        if (a.hasValue(C0028R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0028R.styleable.TextAppearance_textAllCaps, false));
        }
        if (a.hasValue(C0028R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0028R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, a);
        if (a.hasValue(C0028R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0028R.styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, fontVariation);
        }
        a.recycle();
        Typeface typeface = this.mFontTypeface;
