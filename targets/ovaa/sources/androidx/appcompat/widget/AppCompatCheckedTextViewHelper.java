...
class AppCompatCheckedTextViewHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        int resourceId;
        int resourceId2;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0028R.styleable.CheckedTextView, defStyleAttr, 0);
        CheckedTextView checkedTextView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(checkedTextView, checkedTextView.getContext(), C0028R.styleable.CheckedTextView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        boolean checkMarkDrawableLoaded = false;
        try {
            if (a.hasValue(C0028R.styleable.CheckedTextView_checkMarkCompat) && (resourceId2 = a.getResourceId(C0028R.styleable.CheckedTextView_checkMarkCompat, 0)) != 0) {
                try {
            ...
            if (!checkMarkDrawableLoaded && a.hasValue(C0028R.styleable.CheckedTextView_android_checkMark) && (resourceId = a.getResourceId(C0028R.styleable.CheckedTextView_android_checkMark, 0)) != 0) {
            ...
            if (a.hasValue(C0028R.styleable.CheckedTextView_checkMarkTint)) {
                CheckedTextViewCompat.setCheckMarkTintList(this.mView, a.getColorStateList(C0028R.styleable.CheckedTextView_checkMarkTint));
            }
            if (a.hasValue(C0028R.styleable.CheckedTextView_checkMarkTintMode)) {
                CheckedTextViewCompat.setCheckMarkTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0028R.styleable.CheckedTextView_checkMarkTintMode, -1), null));
            }
        } finally {
            a.recycle();
        }
