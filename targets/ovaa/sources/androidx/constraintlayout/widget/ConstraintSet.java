...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintBaseline_toTopOf, BASELINE_TO_TOP);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintBaseline_toBottomOf, BASELINE_TO_BOTTOM);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_guidelineUseRtl, GUIDELINE_USE_RTL);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintWidth_max, WIDTH_MAX);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintHeight_max, HEIGHT_MAX);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintWidth_min, WIDTH_MIN);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintHeight_min, HEIGHT_MIN);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintCircleRadius, CIRCLE_RADIUS);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0177R.styleable.Constraint_animateRelativeTo, 64);
        ...
        mapToConstant.append(C0177R.styleable.Constraint_motionStagger, MOTION_STAGGER);
        mapToConstant.append(C0177R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0177R.styleable.Constraint_motionProgress, PROGRESS);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintWidth_percent, WIDTH_PERCENT);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintHeight_percent, HEIGHT_PERCENT);
        mapToConstant.append(C0177R.styleable.Constraint_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
        mapToConstant.append(C0177R.styleable.Constraint_chainUseRtl, CHAIN_USE_RTL);
        mapToConstant.append(C0177R.styleable.Constraint_barrierDirection, BARRIER_DIRECTION);
        mapToConstant.append(C0177R.styleable.Constraint_barrierMargin, BARRIER_MARGIN);
        mapToConstant.append(C0177R.styleable.Constraint_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        mapToConstant.append(C0177R.styleable.Constraint_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        mapToConstant.append(C0177R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constraintTag, CONSTRAINT_TAG);
        mapToConstant.append(C0177R.styleable.Constraint_visibilityMode, VISIBILITY_MODE);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constrainedWidth, CONSTRAINED_WIDTH);
        mapToConstant.append(C0177R.styleable.Constraint_layout_constrainedHeight, CONSTRAINED_HEIGHT);
        mapToConstant.append(C0177R.styleable.Constraint_polarRelativeTo, ANIMATE_CIRCLE_ANGLE_TO);
        mapToConstant.append(C0177R.styleable.Constraint_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        mapToConstant.append(C0177R.styleable.Constraint_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        mapToConstant.append(C0177R.styleable.Constraint_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        mapToConstant.append(C0177R.styleable.Constraint_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintLeft_creator, UNUSED);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintTop_creator, UNUSED);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintRight_creator, UNUSED);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintBottom_creator, UNUSED);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintBaseline_creator, UNUSED);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintWidth, LAYOUT_CONSTRAINT_WIDTH);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHeight, LAYOUT_CONSTRAINT_HEIGHT);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintWidth_max, WIDTH_MAX);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHeight_max, HEIGHT_MAX);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintWidth_min, WIDTH_MIN);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHeight_min, HEIGHT_MIN);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintCircleRadius, CIRCLE_RADIUS);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_motionStagger, MOTION_STAGGER);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_motionTarget, MOTION_TARGET);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_motionProgress, PROGRESS);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintWidth_percent, WIDTH_PERCENT);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintHeight_percent, HEIGHT_PERCENT);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_chainUseRtl, CHAIN_USE_RTL);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_barrierDirection, BARRIER_DIRECTION);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_barrierMargin, BARRIER_MARGIN);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constraintTag, CONSTRAINT_TAG);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_visibilityMode, VISIBILITY_MODE);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constrainedWidth, CONSTRAINED_WIDTH);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_constrainedHeight, CONSTRAINED_HEIGHT);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_polarRelativeTo, ANIMATE_CIRCLE_ANGLE_TO);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_transformPivotTarget, TRANSFORM_PIVOT_TARGET);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_quantizeMotionSteps, QUANTIZE_MOTION_STEPS);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_quantizeMotionPhase, QUANTIZE_MOTION_PHASE);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_quantizeMotionInterpolator, QUANTIZE_MOTION_INTERPOLATOR);
        overrideMapToConstant.append(C0177R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, LAYOUT_WRAP_BEHAVIOR);
    }
    ...
    public static class Layout {
        ...
        static {
            ...
            mapToConstant.append(C0177R.styleable.Layout_guidelineUseRtl, GUIDE_USE_RTL);
            ...
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
            ...
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0177R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0177R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0177R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintCircleRadius, CIRCLE_RADIUS);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintWidth_percent, WIDTH_PERCENT);
            mapToConstant.append(C0177R.styleable.Layout_layout_constraintHeight_percent, HEIGHT_PERCENT);
            mapToConstant.append(C0177R.styleable.Layout_chainUseRtl, CHAIN_USE_RTL);
            mapToConstant.append(C0177R.styleable.Layout_barrierDirection, BARRIER_DIRECTION);
            mapToConstant.append(C0177R.styleable.Layout_barrierMargin, BARRIER_MARGIN);
            mapToConstant.append(C0177R.styleable.Layout_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
            mapToConstant.append(C0177R.styleable.Layout_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            ...
            mapToConstant.append(C0177R.styleable.Transform_transformPivotTarget, 12);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.Transform);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.PropertySet);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0177R.styleable.PropertySet_android_alpha) {
                    this.alpha = a.getFloat(attr, this.alpha);
                } else if (attr == C0177R.styleable.PropertySet_android_visibility) {
                    this.visibility = a.getInt(attr, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (attr == C0177R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = a.getInt(attr, this.mVisibilityMode);
                } else if (attr == C0177R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            ...
            mapToConstant.append(C0177R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0177R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0177R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0177R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0177R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0177R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.Motion);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(key, constraint.m185clone());
            }
        }
    }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, override ? C0177R.styleable.ConstraintOverride : C0177R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint c = new Constraint();
        TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.ConstraintOverride);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < N; i++) {
            int attr = a.getIndex(i);
            if (attr != C0177R.styleable.Constraint_android_id && C0177R.styleable.Constraint_android_layout_marginStart != attr && C0177R.styleable.Constraint_android_layout_marginEnd != attr) {
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                Field field = C0177R.C0180id.class.getField(idString);
