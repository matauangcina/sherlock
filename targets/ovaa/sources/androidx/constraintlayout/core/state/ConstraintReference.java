...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int value) {
        if (this.mLast != null) {
            switch (C01421.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        int i = C01421.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()];
        switch (C01421.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()]) {
            case 1:
