...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String desc, float time) {
        String ret = ((desc + " ===== " + this.mType + IOUtils.LINE_SEPARATOR_UNIX) + desc + (this.mBackwards ? "backwards" : "forward ") + " time = " + time + "  stages " + this.mNumberOfStages + IOUtils.LINE_SEPARATOR_UNIX) + desc + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        if (this.mNumberOfStages > 1) {
            ret = ret + desc + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        }
        if (this.mNumberOfStages > 2) {
            ret = ret + desc + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        }
