...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f54x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f55y;
    }
    ...
    public float getFinalY() {
        return this.mEndMotionPath.f55y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f54x;
        start.top = this.mStartMotionPath.f55y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f54x;
        end.top = this.mEndMotionPath.f55y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float dy = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
        float startCenterX = this.mStartMotionPath.f54x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f55y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        int varLen2 = Math.max(2, count2);
        this.mInterpolateData = new double[varLen2];
        this.mInterpolateVelocity = new double[varLen2];
        int count3 = 0;
        ...
        if (points[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                ...
                values[i9][0] = points[i9].f54x;
                values[i9][1] = points[i9].f55y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f54x + " y: " + this.mStartMotionPath.f55y + " end: x: " + this.mEndMotionPath.f54x + " y: " + this.mEndMotionPath.f55y;
    }
    ...
    */
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float dTop = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
