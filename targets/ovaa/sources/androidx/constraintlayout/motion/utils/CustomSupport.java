...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute att, View view, float[] value) {
        ...
        try {
            boolean z = true;
            switch (C01551.f49x66adad53[att.getType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C01551 {
        ...
        static final /* synthetic */ int[] f49x66adad53;
        ...
        static {
            ...
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.FLOAT_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f49x66adad53[ConstraintAttribute.AttributeType.DIMENSION_TYPE.ordinal()] = 7;
