...
public final class MetadataList extends Table {
    ...
    public MetadataItem list(MetadataItem obj, int j) {
        int o = __offset(6);
        if (o != 0) {
            return obj.__assign(__indirect(__vector(o) + (j * 4)), this.f88bb);
        }
        return null;
    }
    ...
    public MetadataItem.Vector listVector(MetadataItem.Vector obj) {
        int o = __offset(6);
        if (o != 0) {
            return obj.__assign(__vector(o), 4, this.f88bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList obj, int j) {
            return obj.__assign(MetadataList.__indirect(__element(j), this.f82bb), this.f82bb);
        }
    }
}
