...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0188R.C0190drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0188R.C0191id.notification_main_column);
            outerView.addView(C0188R.C0191id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0188R.C0191id.notification_main_column, 0);
            outerView.setViewPadding(C0188R.C0191id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0188R.C0191id.title, 8);
            outerView.setViewVisibility(C0188R.C0191id.text2, 8);
            outerView.setViewVisibility(C0188R.C0191id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0188R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0188R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0188R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0188R.C0191id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0188R.C0191id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0188R.C0191id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0188R.C0191id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0188R.layout.notification_action_tombstone : C0188R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0188R.C0191id.action_image, createColoredBitmap(icon, this.mBuilder.mContext.getResources().getColor(C0188R.C0189color.notification_action_color_filter)));
            }
            button.setTextViewText(C0188R.C0191id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0188R.C0191id.action_container, action.actionIntent);
            }
            button.setContentDescription(C0188R.C0191id.action_container, action.title);
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m186clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m187clone() {
            WearableExtender that = new WearableExtender();
