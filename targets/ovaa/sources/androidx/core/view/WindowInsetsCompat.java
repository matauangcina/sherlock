...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int left, int top, int right, int bottom) {
        return new Builder(this).setSystemWindowInsets(Insets.m162of(left, top, right, bottom)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect systemWindowInsets) {
        return new Builder(this).setSystemWindowInsets(Insets.m161of(systemWindowInsets)).build();
    }
    ...
    public static class Impl20 extends Impl {
            ...
            switch (type) {
                case 1:
                    if (ignoreVisibility) {
                        ...
                        return Insets.m162of(0, Math.max(rootStable.top, getSystemWindowInsets().top), 0, 0);
                    }
                    Insets rootStable2 = getSystemWindowInsets();
                    return Insets.m162of(0, rootStable2.top, 0, 0);
                case 2:
                    if (ignoreVisibility) {
                        Insets rootStable3 = getRootStableInsets();
                        Insets stable = getStableInsets();
                        return Insets.m162of(Math.max(rootStable3.left, stable.left), 0, Math.max(rootStable3.right, stable.right), Math.max(rootStable3.bottom, stable.bottom));
                    }
                    ...
                    return Insets.m162of(systemWindow.left, 0, systemWindow.right, bottom);
                case 8:
                    ...
                    if (systemWindow2.bottom > rootStable4.bottom) {
                        return Insets.m162of(0, 0, 0, systemWindow2.bottom);
                    }
                    ...
                    if (insets != null && !insets.equals(Insets.NONE) && this.mRootViewVisibleInsets.bottom > rootStable4.bottom) {
                        return Insets.m162of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                    }
                    return Insets.NONE;
                case 16:
                ...
                case 128:
                    ...
                    if (cutout != null) {
                        return Insets.m162of(cutout.getSafeInsetLeft(), cutout.getSafeInsetTop(), cutout.getSafeInsetRight(), cutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                default:
                    return Insets.NONE;
        ...
        final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m162of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
        ...
        private Insets getVisibleInsets(View rootView) {
            ...
            try {
                ...
                if (visibleRect != null) {
                    return Insets.m161of(visibleRect);
                }
                return null;
    ...
    private static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m162of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public static Insets insetInsets(Insets insets, int left, int top, int right, int bottom) {
        ...
        return Insets.m162of(newLeft, newTop, newRight, newBottom);
    }
                ...
                try {
                    ...
                    if (attachInfo != null) {
                        ...
                        if (stableInsets != null && visibleInsets != null) {
                            WindowInsetsCompat insets = new Builder().setStableInsets(Insets.m161of(stableInsets)).setSystemWindowInsets(Insets.m161of(visibleInsets)).build();
