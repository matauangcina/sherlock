...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(Predicate<String> filter) {
            ...
            this.mAllowedActions = this.mAllowedActions.m139or(filter);
            return this;
        }
        ...
        public Builder allowData(Predicate<Uri> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedData = this.mAllowedData.m139or(filter);
            return this;
        }
        ...
        public Builder allowType(Predicate<String> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedTypes = this.mAllowedTypes.m139or(filter);
            return this;
        }
        ...
        public Builder allowCategory(Predicate<String> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedCategories = this.mAllowedCategories.m139or(filter);
            return this;
        }
        ...
        public Builder allowPackage(Predicate<String> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedPackages = this.mAllowedPackages.m139or(filter);
            return this;
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> filter) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m139or(filter);
            return this;
        }
        ...
        public Builder allowClipDataUri(Predicate<Uri> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m139or(filter);
            return this;
        }

        public Builder allowClipData(Predicate<ClipData> filter) {
            Preconditions.checkNotNull(filter);
            this.mAllowedClipData = this.mAllowedClipData.m139or(filter);
            return this;
        }
        ...
        public Builder allowExtra(String key, Predicate<Object> filter) {
            ...
            this.mAllowedExtras.put(key, allowedExtra.m139or(filter));
            return this;
        }
