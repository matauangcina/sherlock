    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(mostSpecific.getKey()) + IOUtils.DIR_SEPARATOR_UNIX + Uri.encode(path, "/")).build();
            } catch (IOException e) {
