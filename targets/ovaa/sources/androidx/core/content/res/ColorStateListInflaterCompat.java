        ...
        while (true) {
            ...
            if (next != i && ((depth = parser.getDepth()) >= innerDepth2 || type != 3)) {
                if (type != 2 || depth > innerDepth2) {
                    ...
                    TypedArray a = obtainAttributes(resources, theme2, attrs, C0188R.styleable.ColorStateListItem);
                    int resourceId = a.getResourceId(C0188R.styleable.ColorStateListItem_android_color, -1);
                    if (resourceId != -1 && !isColorInt(resources, resourceId)) {
                        try {
                            ...
                            baseColor = a.getColor(C0188R.styleable.ColorStateListItem_android_color, -65281);
                        }
                    } else {
                        int baseColor2 = C0188R.styleable.ColorStateListItem_android_color;
                        baseColor = a.getColor(baseColor2, -65281);
                    }
                    float alphaMod = 1.0f;
                    if (a.hasValue(C0188R.styleable.ColorStateListItem_android_alpha)) {
                        alphaMod = a.getFloat(C0188R.styleable.ColorStateListItem_android_alpha, 1.0f);
                    } else if (a.hasValue(C0188R.styleable.ColorStateListItem_alpha)) {
                        alphaMod = a.getFloat(C0188R.styleable.ColorStateListItem_alpha, 1.0f);
                    }
                    if (Build.VERSION.SDK_INT >= 31 && a.hasValue(C0188R.styleable.ColorStateListItem_android_lStar)) {
                        lStar = a.getFloat(C0188R.styleable.ColorStateListItem_android_lStar, -1.0f);
                    } else {
                        lStar = a.getFloat(C0188R.styleable.ColorStateListItem_lStar, -1.0f);
                    }
                    a.recycle();
                    int j = 0;
                    ...
                    while (i2 < numAttrs) {
                        ...
                        int type2 = type;
                        if (stateResId != 16843173 && stateResId != 16843551 && stateResId != C0188R.attr.alpha && stateResId != C0188R.attr.lStar) {
                            int j2 = j + 1;
