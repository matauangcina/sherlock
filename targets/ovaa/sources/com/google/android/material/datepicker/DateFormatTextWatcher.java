...
public abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String formatHint, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints constraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0566R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DateFormatTextWatcher.this.m73x5657fb8e(formatHint);
            }
        };
    }
    ...
    public /* synthetic */ void m73x5657fb8e(String formatHint) {
        TextInputLayout textLayout = this.textInputLayout;
        DateFormat df = this.dateFormat;
        Context context = textLayout.getContext();
        String invalidFormat = context.getString(C0566R.string.mtrl_picker_invalid_format);
        String useLine = String.format(context.getString(C0566R.string.mtrl_picker_invalid_format_use), sanitizeDateString(formatHint));
        String exampleLine = String.format(context.getString(C0566R.string.mtrl_picker_invalid_format_example), sanitizeDateString(df.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
        textLayout.setError(invalidFormat + IOUtils.LINE_SEPARATOR_UNIX + useLine + IOUtils.LINE_SEPARATOR_UNIX + exampleLine);
        onInvalidDate();
    }
    ...
    private Runnable createRangeErrorCallback(final long milliseconds) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                DateFormatTextWatcher.this.m74x14d77527(milliseconds);
            }
        };
    }
    ...
    public /* synthetic */ void m74x14d77527(long milliseconds) {
