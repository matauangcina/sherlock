...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(r0)) {
            int layout2 = C0566R.layout.mtrl_calendar_vertical;
            layout = layout2;
            orientation = 1;
        } else {
            int layout3 = C0566R.layout.mtrl_calendar_horizontal;
            layout = layout3;
            orientation = 0;
        }
        View root = themedInflater.inflate(layout, viewGroup, false);
        root.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView daysHeader = (GridView) root.findViewById(C0566R.C0569id.mtrl_calendar_days_of_week);
        ...
        ?? r02 = (RecyclerView) root.findViewById(C0566R.C0569id.mtrl_calendar_months);
        ...
        int columns = r02.getResources().getInteger(C0566R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) root.findViewById(C0566R.C0569id.mtrl_calendar_year_selector_frame);
        ...
        if (r8.findViewById(C0566R.C0569id.month_navigation_fragment_toggle) != null) {
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0566R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton monthDropSelect = (MaterialButton) root.findViewById(C0566R.C0569id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(monthDropSelect, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C0566R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C0566R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        View findViewById = root.findViewById(C0566R.C0569id.month_navigation_previous);
        this.monthPrev = findViewById;
        findViewById.setTag(NAVIGATION_PREV_TAG);
        View findViewById2 = root.findViewById(C0566R.C0569id.month_navigation_next);
        this.monthNext = findViewById2;
        findViewById2.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(C0566R.C0569id.mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(C0566R.C0569id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int navigationHeight = resources.getDimensionPixelSize(C0566R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0566R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0566R.dimen.mtrl_calendar_navigation_bottom_padding);
        int daysOfWeekHeight = resources.getDimensionPixelSize(C0566R.dimen.mtrl_calendar_days_of_week_height);
        int calendarHeight = (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0566R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0566R.dimen.mtrl_calendar_month_vertical_padding));
        int calendarPadding = resources.getDimensionPixelOffset(C0566R.dimen.mtrl_calendar_bottom_padding);
