...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, final OnSelectionChangedListener<Long> listener) {
        ...
        View root = layoutInflater.inflate(C0566R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout dateTextInput = (TextInputLayout) root.findViewById(C0566R.C0569id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C0566R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return res.getString(C0566R.string.mtrl_picker_date_header_unselected);
        }
        String startString = DateStrings.getYearMonthDay(l.longValue());
        return res.getString(C0566R.string.mtrl_picker_date_header_selected, startString);
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            placeholder = res.getString(C0566R.string.mtrl_picker_announce_current_selection_none);
        } else {
            placeholder = DateStrings.getYearMonthDay(l.longValue());
        }
        return res.getString(C0566R.string.mtrl_picker_announce_current_selection, placeholder);
    }
    ...
    public int getDefaultTitleResId() {
        return C0566R.string.mtrl_picker_date_header_title;
    }
