...
public class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0566R.C0569id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0566R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0566R.C0569id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0566R.C0569id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i, boolean z) {
                TimePickerView.this.m33x9f44237d(materialButtonToggleGroup2, i, z);
            }
        });
        this.minuteView = (Chip) findViewById(C0566R.C0569id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0566R.C0569id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C0566R.C0569id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    public /* synthetic */ void m33x9f44237d(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0566R.C0569id.selection_type, 12);
        this.hourView.setTag(C0566R.C0569id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        int checkedId;
        if (period == 1) {
            checkedId = C0566R.C0569id.material_clock_period_pm_button;
        } else {
            checkedId = C0566R.C0569id.material_clock_period_am_button;
        }
