...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.currentLevel = 1;
        TypedArray a = context.obtainStyledAttributes(attrs, C0566R.styleable.ClockHandView, defStyleAttr, C0566R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.animationDuration = MotionUtils.resolveThemeDuration(context, C0566R.attr.motionDurationLong2, 200);
        this.animationInterpolator = MotionUtils.resolveThemeInterpolator(context, C0566R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        this.circleRadius = a.getDimensionPixelSize(C0566R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = a.getDimensionPixelSize(C0566R.styleable.ClockHandView_selectorSize, 0);
        Resources res = getResources();
        this.selectorStrokeWidth = res.getDimensionPixelSize(C0566R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = res.getDimensionPixelSize(C0566R.dimen.material_clock_hand_center_dot_radius);
        int selectorColor = a.getColor(C0566R.styleable.ClockHandView_clockHandColor, 0);
    ...
    public void setHandRotation(float degrees, boolean animate) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.ClockHandView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ClockHandView.this.m36xb17f7076(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m36xb17f7076(ValueAnimator animation) {
