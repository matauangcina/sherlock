...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        } else if (transitionValues.view.getTag(C0566R.C0569id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C0566R.C0569id.mtrl_motion_snapshot_view, null);
            transitionValues.view = (View) transitionValues.view.getTag(C0566R.C0569id.mtrl_motion_snapshot_view);
        }
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        if (view.getTag(C0566R.C0569id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C0566R.C0569id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{C0566R.attr.transitionShapeAppearance});
    ...
    private void maybeApplyThemeValues(Context context, boolean entering) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C0566R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, entering ? C0566R.attr.motionDurationLong2 : C0566R.attr.motionDurationMedium4);
        if (!this.pathMotionCustom) {
            TransitionUtils.maybeApplyThemePath(this, context, C0566R.attr.motionPath);
        }
    }
