...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            float height = this.operation.f162y - this.startY;
            float width = this.operation.f161x - this.startX;
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f162y - this.startY) / (this.operation.f161x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                double length1 = Math.hypot(this.operation1.f161x - this.startX, this.operation1.f162y - this.startY);
                double length22 = Math.hypot(this.operation2.f161x - this.operation1.f161x, this.operation2.f162y - this.operation1.f162y);
                ...
                this.renderMatrix.set(transform);
                this.renderMatrix.preTranslate(this.operation1.f161x, this.operation1.f162y);
                this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f162y - this.startY) / (this.operation1.f161x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f162y - this.operation1.f162y) / (this.operation2.f161x - this.operation1.f161x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix transform, Path path) {
            ...
            path.lineTo(this.f161x, this.f162y);
