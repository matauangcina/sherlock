...
public class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C0566R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C0566R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C0566R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C0566R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    private AnimatorSet createDefaultAnimator(final float targetOpacity, final float targetScale, final float targetIconScale, int duration, int interpolator) {
        ...
        AnimatorSetCompat.playTogether(set, animators);
        set.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), duration, this.view.getContext().getResources().getInteger(C0566R.integer.material_motion_duration_long_1)));
    ...
    /* loaded from: classes.dex */
    class C06925 implements TypeEvaluator<Float> {
