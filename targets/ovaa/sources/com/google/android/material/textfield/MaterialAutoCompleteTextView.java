...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0566R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0566R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0566R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0566R.styleable.MaterialAutoCompleteTextView_android_inputType)) {
            int inputType = attributes.getInt(C0566R.styleable.MaterialAutoCompleteTextView_android_inputType, 0);
            if (inputType == 0) {
                setKeyListener(null);
            }
        }
        int inputType2 = C0566R.styleable.MaterialAutoCompleteTextView_simpleItemLayout;
        this.simpleItemLayout = attributes.getResourceId(inputType2, C0566R.layout.mtrl_auto_complete_simple_item);
        this.popupElevation = attributes.getDimensionPixelOffset(C0566R.styleable.MaterialAutoCompleteTextView_android_popupElevation, C0566R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        if (attributes.hasValue(C0566R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint)) {
            this.dropDownBackgroundTint = ColorStateList.valueOf(attributes.getColor(C0566R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint, 0));
        }
        this.simpleItemSelectedColor = attributes.getColor(C0566R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedColor, 0);
        this.simpleItemSelectedRippleColor = MaterialResources.getColorStateList(context2, attributes, C0566R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedRippleColor);
        ...
        if (attributes.hasValue(C0566R.styleable.MaterialAutoCompleteTextView_simpleItems)) {
            setSimpleItems(attributes.getResourceId(C0566R.styleable.MaterialAutoCompleteTextView_simpleItems, 0));
        }
        attributes.recycle();
    }
