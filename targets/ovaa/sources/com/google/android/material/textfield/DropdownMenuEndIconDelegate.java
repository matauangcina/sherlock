...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public /* synthetic */ void m43xd03fedd4(View view) {
        showHideDropdown();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-android-material-textfield-DropdownMenuEndIconDelegate */
    public /* synthetic */ void m42xac016995(View view, boolean hasFocus) {
    ...
    public /* synthetic */ void m41x87c2e556(boolean enabled) {
    ...
    public DropdownMenuEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                DropdownMenuEndIconDelegate.this.m43xd03fedd4(view);
            }
        };
        this.onEditTextFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view, boolean z) {
                DropdownMenuEndIconDelegate.this.m42xac016995(view, z);
            }
        };
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                DropdownMenuEndIconDelegate.this.m41x87c2e556(z);
            }
        };
        this.dropdownPopupActivatedAt = Long.MAX_VALUE;
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0566R.attr.motionDurationShort3, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0566R.attr.motionDurationShort3, 50);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0566R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    public int getIconDrawableResId() {
        return IS_LOLLIPOP ? C0566R.C0568drawable.mtrl_dropdown_arrow : C0566R.C0568drawable.mtrl_ic_arrow_drop_down;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C0566R.string.exposed_dropdown_menu_content_description;
    }
    ...
    public void afterEditTextChanged(Editable s) {
        ...
        this.autoCompleteTextView.post(new Runnable() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void run() {
                DropdownMenuEndIconDelegate.this.m45xae660ff2();
            }
        });
    }
    ...
    public /* synthetic */ void m45xae660ff2() {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda5
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return DropdownMenuEndIconDelegate.this.m40x5f2e2537(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda6
                ...
                public final void onDismiss() {
                    DropdownMenuEndIconDelegate.this.m39x3aefa0f8();
                }
            });
        }
    ...
    public /* synthetic */ boolean m40x5f2e2537(View view, MotionEvent event) {
    ...
    public /* synthetic */ void m39x3aefa0f8() {
        updateDropdownPopupDirty();
        setEndIconChecked(false);
    }
    ...
    private ValueAnimator getAlphaAnimator(int duration, float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda3
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                DropdownMenuEndIconDelegate.this.m44x6b943a83(valueAnimator);
            }
        });
        return animator;
    }
    ...
    public /* synthetic */ void m44x6b943a83(ValueAnimator animation) {
