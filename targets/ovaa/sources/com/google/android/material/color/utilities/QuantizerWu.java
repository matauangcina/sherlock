...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box cube) {
        ...
        double xx = ((((((this.moments[getIndex(cube.f152r1, cube.f150g1, cube.f148b1)] - this.moments[getIndex(cube.f152r1, cube.f150g1, cube.f147b0)]) - this.moments[getIndex(cube.f152r1, cube.f149g0, cube.f148b1)]) + this.moments[getIndex(cube.f152r1, cube.f149g0, cube.f147b0)]) - this.moments[getIndex(cube.f151r0, cube.f150g1, cube.f148b1)]) + this.moments[getIndex(cube.f151r0, cube.f150g1, cube.f147b0)]) + this.moments[getIndex(cube.f151r0, cube.f149g0, cube.f148b1)]) - this.moments[getIndex(cube.f151r0, cube.f149g0, cube.f147b0)];
    ...
    Boolean cut(Box one, Box two) {
        ...
        MaximizeResult maxRResult = maximize(one, Direction.RED, one.f151r0 + 1, one.f152r1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxGResult = maximize(one, Direction.GREEN, one.f149g0 + 1, one.f150g1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxBResult = maximize(one, Direction.BLUE, one.f147b0 + 1, one.f148b1, wholeR, wholeG, wholeB, wholeW);
        ...
        two.f152r1 = one.f152r1;
        two.f150g1 = one.f150g1;
        two.f148b1 = one.f148b1;
        switch (C06431.f146x8739cebf[cutDirection.ordinal()]) {
            case 1:
                one.f152r1 = maxRResult.cutLocation;
                two.f151r0 = one.f152r1;
                two.f149g0 = one.f149g0;
                two.f147b0 = one.f147b0;
                break;
            case 2:
                one.f150g1 = maxGResult.cutLocation;
                two.f151r0 = one.f151r0;
                two.f149g0 = one.f150g1;
                two.f147b0 = one.f147b0;
                break;
            case 3:
                one.f148b1 = maxBResult.cutLocation;
                two.f151r0 = one.f151r0;
                two.f149g0 = one.f149g0;
                two.f147b0 = one.f148b1;
                break;
        }
        one.vol = (one.f152r1 - one.f151r0) * (one.f150g1 - one.f149g0) * (one.f148b1 - one.f147b0);
        two.vol = (two.f152r1 - two.f151r0) * (two.f150g1 - two.f149g0) * (two.f148b1 - two.f147b0);
        return true;
    }
    ...
    public static /* synthetic */ class C06431 {
        ...
        static final /* synthetic */ int[] f146x8739cebf;
        ...
        static {
            ...
            try {
                f146x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f146x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box cube, int[] moment) {
        return ((((((moment[getIndex(cube.f152r1, cube.f150g1, cube.f148b1)] - moment[getIndex(cube.f152r1, cube.f150g1, cube.f147b0)]) - moment[getIndex(cube.f152r1, cube.f149g0, cube.f148b1)]) + moment[getIndex(cube.f152r1, cube.f149g0, cube.f147b0)]) - moment[getIndex(cube.f151r0, cube.f150g1, cube.f148b1)]) + moment[getIndex(cube.f151r0, cube.f150g1, cube.f147b0)]) + moment[getIndex(cube.f151r0, cube.f149g0, cube.f148b1)]) - moment[getIndex(cube.f151r0, cube.f149g0, cube.f147b0)];
    }

    static int bottom(Box cube, Direction direction, int[] moment) {
        switch (C06431.f146x8739cebf[direction.ordinal()]) {
            case 1:
                return (((-moment[getIndex(cube.f151r0, cube.f150g1, cube.f148b1)]) + moment[getIndex(cube.f151r0, cube.f150g1, cube.f147b0)]) + moment[getIndex(cube.f151r0, cube.f149g0, cube.f148b1)]) - moment[getIndex(cube.f151r0, cube.f149g0, cube.f147b0)];
            case 2:
                return (((-moment[getIndex(cube.f152r1, cube.f149g0, cube.f148b1)]) + moment[getIndex(cube.f152r1, cube.f149g0, cube.f147b0)]) + moment[getIndex(cube.f151r0, cube.f149g0, cube.f148b1)]) - moment[getIndex(cube.f151r0, cube.f149g0, cube.f147b0)];
            case 3:
                return (((-moment[getIndex(cube.f152r1, cube.f150g1, cube.f147b0)]) + moment[getIndex(cube.f152r1, cube.f149g0, cube.f147b0)]) + moment[getIndex(cube.f151r0, cube.f150g1, cube.f147b0)]) - moment[getIndex(cube.f151r0, cube.f149g0, cube.f147b0)];
            default:
    ...
    static int top(Box cube, Direction direction, int position, int[] moment) {
        switch (C06431.f146x8739cebf[direction.ordinal()]) {
            case 1:
                return ((moment[getIndex(position, cube.f150g1, cube.f148b1)] - moment[getIndex(position, cube.f150g1, cube.f147b0)]) - moment[getIndex(position, cube.f149g0, cube.f148b1)]) + moment[getIndex(position, cube.f149g0, cube.f147b0)];
            case 2:
                return ((moment[getIndex(cube.f152r1, position, cube.f148b1)] - moment[getIndex(cube.f152r1, position, cube.f147b0)]) - moment[getIndex(cube.f151r0, position, cube.f148b1)]) + moment[getIndex(cube.f151r0, position, cube.f147b0)];
            case 3:
                return ((moment[getIndex(cube.f152r1, cube.f150g1, position)] - moment[getIndex(cube.f152r1, cube.f149g0, position)]) - moment[getIndex(cube.f151r0, cube.f150g1, position)]) + moment[getIndex(cube.f151r0, cube.f149g0, position)];
            default:
                throw new IllegalArgumentException("unexpected direction " + direction);
        }
    }
