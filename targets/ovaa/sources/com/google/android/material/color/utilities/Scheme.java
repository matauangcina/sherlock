...
public class Scheme {
    ...
    public static Scheme light(int argb) {
        return lightFromCorePalette(CorePalette.m116of(argb));
    }

    public static Scheme dark(int argb) {
        return darkFromCorePalette(CorePalette.m116of(argb));
    }
    ...
    private static Scheme lightFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f141a1.tone(40)).withOnPrimary(core.f141a1.tone(100)).withPrimaryContainer(core.f141a1.tone(90)).withOnPrimaryContainer(core.f141a1.tone(10)).withSecondary(core.f142a2.tone(40)).withOnSecondary(core.f142a2.tone(100)).withSecondaryContainer(core.f142a2.tone(90)).withOnSecondaryContainer(core.f142a2.tone(10)).withTertiary(core.f143a3.tone(40)).withOnTertiary(core.f143a3.tone(100)).withTertiaryContainer(core.f143a3.tone(90)).withOnTertiaryContainer(core.f143a3.tone(10)).withError(core.error.tone(40)).withOnError(core.error.tone(100)).withErrorContainer(core.error.tone(90)).withOnErrorContainer(core.error.tone(10)).withBackground(core.f144n1.tone(99)).withOnBackground(core.f144n1.tone(10)).withSurface(core.f144n1.tone(99)).withOnSurface(core.f144n1.tone(10)).withSurfaceVariant(core.f145n2.tone(90)).withOnSurfaceVariant(core.f145n2.tone(30)).withOutline(core.f145n2.tone(50)).withOutlineVariant(core.f145n2.tone(80)).withShadow(core.f144n1.tone(0)).withScrim(core.f144n1.tone(0)).withInverseSurface(core.f144n1.tone(20)).withInverseOnSurface(core.f144n1.tone(95)).withInversePrimary(core.f141a1.tone(80));
    }

    private static Scheme darkFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f141a1.tone(80)).withOnPrimary(core.f141a1.tone(20)).withPrimaryContainer(core.f141a1.tone(30)).withOnPrimaryContainer(core.f141a1.tone(90)).withSecondary(core.f142a2.tone(80)).withOnSecondary(core.f142a2.tone(20)).withSecondaryContainer(core.f142a2.tone(30)).withOnSecondaryContainer(core.f142a2.tone(90)).withTertiary(core.f143a3.tone(80)).withOnTertiary(core.f143a3.tone(20)).withTertiaryContainer(core.f143a3.tone(30)).withOnTertiaryContainer(core.f143a3.tone(90)).withError(core.error.tone(80)).withOnError(core.error.tone(20)).withErrorContainer(core.error.tone(30)).withOnErrorContainer(core.error.tone(80)).withBackground(core.f144n1.tone(10)).withOnBackground(core.f144n1.tone(90)).withSurface(core.f144n1.tone(10)).withOnSurface(core.f144n1.tone(90)).withSurfaceVariant(core.f145n2.tone(30)).withOnSurfaceVariant(core.f145n2.tone(80)).withOutline(core.f145n2.tone(60)).withOutlineVariant(core.f145n2.tone(30)).withShadow(core.f144n1.tone(0)).withScrim(core.f144n1.tone(0)).withInverseSurface(core.f144n1.tone(90)).withInverseOnSurface(core.f144n1.tone(20)).withInversePrimary(core.f141a1.tone(40));
    }
