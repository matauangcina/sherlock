...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C0566R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C0566R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C0566R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C0566R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
