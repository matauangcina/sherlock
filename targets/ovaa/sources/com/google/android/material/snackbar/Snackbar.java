...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0566R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0566R.attr.snackbarButtonStyle, C0566R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i = C0566R.layout.mtrl_layout_snackbar_include;
        } else {
            i = C0566R.layout.design_layout_snackbar_include;
        }
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    Snackbar.this.m204lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(listener, view);
                }
            });
        }
        return this;
    ...
    public /* synthetic */ void m204lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener listener, View view) {
