...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (i3 >= i4) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f199dn);
        }
        this.end = i3;
        if (this.chars[i3] == ' ') {
            while (true) {
        ...
        while (true) {
            ...
            switch (c2) {
                ...
                case ';':
                    ...
                    int i8 = this.beg;
                    return new String(cArr4, i8, this.end - i8);
                case '\\':
                    int i9 = this.end;
                    this.end = i9 + 1;
                    cArr2[i9] = getEscaped();
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f199dn);
        }
        char[] cArr = this.chars;
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f199dn.toCharArray();
