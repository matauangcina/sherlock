...
public class C0645s extends RadioButton implements InterfaceC0781j, InterfaceC0251r {

    /* renamed from: f */
    private final C0605i f2185f;

    /* renamed from: g */
    private final C0592e f2186g;

    /* renamed from: h */
    private final C0670y f2187h;

    public C0645s(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0000a.radioButtonStyle);
    }

    public C0645s(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void drawableStateChanged() {
        ...
        C0592e c0592e = this.f2186g;
        if (c0592e != null) {
            c0592e.m7478b();
        }
        C0670y c0670y = this.f2187h;
        if (c0670y != null) {
            c0670y.m7165b();
        }
    }
