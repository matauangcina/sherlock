...
public class C0622m extends ImageButton implements InterfaceC0251r, InterfaceC0783l {

    /* renamed from: f */
    private final C0592e f2105f;

    /* renamed from: g */
    private final C0630n f2106g;

    public C0622m(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0000a.imageButtonStyle);
    }

    public C0622m(Context context, AttributeSet attributeSet, int i) {
    ...
    protected void drawableStateChanged() {
        ...
        C0592e c0592e = this.f2105f;
        if (c0592e != null) {
            c0592e.m7478b();
        }
        C0630n c0630n = this.f2106g;
        if (c0630n != null) {
            c0630n.m7323b();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return this.f2106g.m7320e() && super.hasOverlappingRendering();
    }
