...
public class C0589d extends AutoCompleteTextView implements InterfaceC0251r {

    /* renamed from: h */
    private static final int[] f1979h = {16843126};

    /* renamed from: f */
    private final C0592e f1980f;

    /* renamed from: g */
    private final C0670y f1981g;

    public C0589d(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0000a.autoCompleteTextViewStyle);
    }

    public C0589d(Context context, AttributeSet attributeSet, int i) {
        super(C0648t0.m7263b(context), attributeSet, i);
        C0665w0 m7213u = C0665w0.m7213u(getContext(), attributeSet, f1979h, i, 0);
        if (m7213u.m7216r(0)) {
    ...
    protected void drawableStateChanged() {
        ...
        C0592e c0592e = this.f1980f;
        if (c0592e != null) {
            c0592e.m7478b();
        }
        C0670y c0670y = this.f1981g;
        if (c0670y != null) {
            c0670y.m7165b();
        }
    }
