...
/* renamed from: b.c.a.a.d.c.r1 */
/* loaded from: classes.dex */
public final class C1240r1 implements Parcelable.Creator<C1243s1> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C1243s1 createFromParcel(Parcel parcel) {
        ...
        return new C1243s1(str, str2, str3, j);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ C1243s1[] newArray(int i) {
        return new C1243s1[i];
    }
}
