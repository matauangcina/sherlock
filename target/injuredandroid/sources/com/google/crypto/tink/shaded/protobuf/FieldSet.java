...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.google.crypto.tink.shaded.protobuf.FieldSet$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class C20611 {
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        /* synthetic */ Builder(C20611 c20611) {
            this();
        }
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C20611 c20611) {
        this(smallSortedMap);
    }
    ...
    static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (C20611.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C20611.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 1:
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C20611) null);
    }
