...
public enum FieldType {
    ...
    /* renamed from: id */
    private final int f5828id;
    private final JavaType javaType;
    private final boolean primitiveScalar;

    /* renamed from: com.google.crypto.tink.shaded.protobuf.FieldType$1 */
    /* loaded from: classes.dex */
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f5828id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C20621.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z = true;
        this.elementType = (i3 == 1 || i3 == 2) ? javaType.getBoxedType() : null;
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C20621.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : false;
    }
