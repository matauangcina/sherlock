...
public class MapEntryLite<K, V> {
    ...
    /* renamed from: com.google.crypto.tink.shaded.protobuf.MapEntryLite$1 */
    /* loaded from: classes.dex */
    ...
    static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t) {
        int i = C20681.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()];
        if (i == 1) {
