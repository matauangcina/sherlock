...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C20631 {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        /* renamed from: clone */
        public BuilderType mo9581clone() {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            if (fieldSet.isImmutable()) {
                FieldSet<ExtensionDescriptor> m9582clone = fieldSet.m9582clone();
                ((ExtendableMessage) this.instance).extensions = m9582clone;
                return m9582clone;
            }
            return fieldSet;
        }
        ...
        protected void copyOnWriteInternal() {
            ...
            ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m9582clone();
        }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected class ExtensionWriter {
            ...
            /* synthetic */ ExtensionWriter(ExtendableMessage extendableMessage, boolean z, C20631 c20631) {
                this(z);
            }
        ...
        */
        ...
        public FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m9582clone();
            }
        ...
        protected <MessageType extends MessageLite> boolean parseUnknownField(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int i) {
        ...
        protected <MessageType extends MessageLite> boolean parseUnknownFieldAsMessageSet(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int i) {
    ...
    protected static final class SerializedForm implements Serializable {
        ...
        /* renamed from: of */
        public static SerializedForm m2428of(MessageLite messageLite) {
    ...
    static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, byte[] bArr, int i, int i2, ExtensionRegistryLite extensionRegistryLite) {
        T t2 = (T) t.dynamicMethod(MethodToInvoke.NEW_MUTABLE_INSTANCE);
        try {
            Schema schemaFor = Protobuf.getInstance().schemaFor((Protobuf) t2);
