...
public final class EciesHkdfSenderKem {
    ...
    public static final class KemKey {
        ...
        public KemKey(byte[] bArr, byte[] bArr2) {
            this.kemBytes = ImmutableByteArray.m2425of(bArr);
            this.symmetricKey = ImmutableByteArray.m2425of(bArr2);
        }
    ...
    public KemKey generateKey(String str, byte[] bArr, byte[] bArr2, int i, EllipticCurves.PointFormatType pointFormatType) {
