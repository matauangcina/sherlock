    ...
    public static byte[] computeMac(byte[] bArr, byte[] bArr2) {
        if (bArr.length == 32) {
            ...
            while (i3 < bArr2.length) {
                ...
                long load2610 = j8 + (load26(bArr3, 12, 8) | (bArr3[16] << 24));
            ...
            long load32 = ((j32 | (j26 & j37) | (j38 << 26)) & 4294967295L) + load32(bArr, 16);
            long j41 = load32 & 4294967295L;
            long load322 = (((j38 >> 6) | (j39 << 20)) & 4294967295L) + load32(bArr, 20) + (load32 >> 32);
            long load323 = (((j39 >> 12) | (j40 << 14)) & 4294967295L) + load32(bArr, 24) + (load322 >> 32);
            byte[] bArr4 = new byte[16];
            toByteArray(bArr4, j41, 0);
            toByteArray(bArr4, load322 & 4294967295L, 4);
            toByteArray(bArr4, load323 & 4294967295L, 8);
            toByteArray(bArr4, ((((j40 >> 18) | (((j30 & j37) | j36) << 8)) & 4294967295L) + load32(bArr, 28) + (load323 >> 32)) & 4294967295L, 12);
            return bArr4;
        }
