...
public final class Ed25519 {
    ...
    public static class CachedXYZT extends CachedXYT {
        ...
        CachedXYZT(XYZT xyzt) {
            ...
            XYZ xyz = xyzt.xyz;
            Field25519.sum(jArr, xyz.f5836y, xyz.f5835x);
            long[] jArr2 = this.yMinusX;
            XYZ xyz2 = xyzt.xyz;
            Field25519.sub(jArr2, xyz2.f5836y, xyz2.f5835x);
            System.arraycopy(xyzt.xyz.f5837z, 0, this.f5833z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f5838t, Ed25519Constants.f5841D2);
        }
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f5833z);
        }
    }
    ...
    public static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f5834t = Arrays.copyOf(partialXYZT.f5834t, 10);
        }
    ...
    public static class XYZ {
        ...
        XYZ(XYZ xyz) {
            this.f5835x = Arrays.copyOf(xyz.f5835x, 10);
            this.f5836y = Arrays.copyOf(xyz.f5836y, 10);
            this.f5837z = Arrays.copyOf(xyz.f5837z, 10);
        }
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f5835x, partialXYZT.xyz.f5835x, partialXYZT.f5834t);
            long[] jArr = xyz.f5836y;
            XYZ xyz2 = partialXYZT.xyz;
            Field25519.mult(jArr, xyz2.f5836y, xyz2.f5837z);
            Field25519.mult(xyz.f5837z, partialXYZT.xyz.f5837z, partialXYZT.f5834t);
            return xyz;
        }

        boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f5835x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f5836y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f5837z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f5840D);
        ...
        byte[] toBytes() {
            ...
            long[] jArr2 = new long[10];
            long[] jArr3 = new long[10];
            Field25519.inverse(jArr, this.f5837z);
            Field25519.mult(jArr2, this.f5835x, jArr);
            Field25519.mult(jArr3, this.f5836y, jArr);
    ...
    public static class XYZT {
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f5840D);
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f5835x, partialXYZT.xyz.f5835x, partialXYZT.f5834t);
            long[] jArr = xyzt.xyz.f5836y;
            XYZ xyz = partialXYZT.xyz;
            Field25519.mult(jArr, xyz.f5836y, xyz.f5837z);
            Field25519.mult(xyzt.xyz.f5837z, partialXYZT.xyz.f5837z, partialXYZT.f5834t);
            long[] jArr2 = xyzt.f5838t;
            XYZ xyz2 = partialXYZT.xyz;
            Field25519.mult(jArr2, xyz2.f5835x, xyz2.f5836y);
            return xyzt;
        }
    }
    ...
    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        long[] jArr2 = partialXYZT.xyz.f5835x;
        XYZ xyz = xyzt.xyz;
        Field25519.sum(jArr2, xyz.f5836y, xyz.f5835x);
        long[] jArr3 = partialXYZT.xyz.f5836y;
        XYZ xyz2 = xyzt.xyz;
        Field25519.sub(jArr3, xyz2.f5836y, xyz2.f5835x);
        long[] jArr4 = partialXYZT.xyz.f5836y;
        Field25519.mult(jArr4, jArr4, cachedXYT.yMinusX);
        XYZ xyz3 = partialXYZT.xyz;
        Field25519.mult(xyz3.f5837z, xyz3.f5835x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f5834t, xyzt.f5838t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f5835x, xyzt.xyz.f5837z);
        long[] jArr5 = partialXYZT.xyz.f5835x;
        Field25519.sum(jArr, jArr5, jArr5);
        XYZ xyz4 = partialXYZT.xyz;
        Field25519.sub(xyz4.f5835x, xyz4.f5837z, xyz4.f5836y);
        XYZ xyz5 = partialXYZT.xyz;
        long[] jArr6 = xyz5.f5836y;
        Field25519.sum(jArr6, xyz5.f5837z, jArr6);
        Field25519.sum(partialXYZT.xyz.f5837z, jArr, partialXYZT.f5834t);
        long[] jArr7 = partialXYZT.f5834t;
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f5839B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f5839B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }
    ...
    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f5835x, xyz.f5835x);
        Field25519.square(partialXYZT.xyz.f5837z, xyz.f5836y);
        Field25519.square(partialXYZT.f5834t, xyz.f5837z);
        long[] jArr2 = partialXYZT.f5834t;
        Field25519.sum(jArr2, jArr2, jArr2);
        Field25519.sum(partialXYZT.xyz.f5836y, xyz.f5835x, xyz.f5836y);
        Field25519.square(jArr, partialXYZT.xyz.f5836y);
        XYZ xyz2 = partialXYZT.xyz;
        Field25519.sum(xyz2.f5836y, xyz2.f5837z, xyz2.f5835x);
        XYZ xyz3 = partialXYZT.xyz;
        long[] jArr3 = xyz3.f5837z;
        Field25519.sub(jArr3, jArr3, xyz3.f5835x);
        XYZ xyz4 = partialXYZT.xyz;
        Field25519.sub(xyz4.f5835x, jArr, xyz4.f5836y);
        long[] jArr4 = partialXYZT.f5834t;
        Field25519.sub(jArr4, jArr4, partialXYZT.xyz.f5837z);
    }
    ...
    /* renamed from: eq */
    private static int m2427eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static void mulAdd(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        long load314 = (load3(bArr4, 0) & 2097151) + (load3 * load37);
        long load413 = ((load4(bArr4, 2) >> 5) & 2097151) + (load3 * load47) + (load4 * load37);
        long load315 = ((load3(bArr4, 5) >> 2) & 2097151) + (load3 * load38) + (load4 * load47) + (load32 * load37);
        long load414 = ((load4(bArr4, 7) >> 7) & 2097151) + (load3 * load48) + (load4 * load38) + (load32 * load47) + (load42 * load37);
        long load415 = ((load4(bArr4, 10) >> 4) & 2097151) + (load3 * load49) + (load4 * load48) + (load32 * load38) + (load42 * load47) + (load43 * load37);
        long load316 = ((load3(bArr4, 13) >> 1) & 2097151) + (load3 * load39) + (load4 * load49) + (load32 * load48) + (load42 * load38) + (load43 * load47) + (load33 * load37);
        long load416 = ((load4(bArr4, 15) >> 6) & 2097151) + (load3 * load410) + (load4 * load39) + (load32 * load49) + (load42 * load48) + (load43 * load38) + (load33 * load47) + (load44 * load37);
        long load317 = ((load3(bArr4, 18) >> 3) & 2097151) + (load3 * load310) + (load4 * load410) + (load32 * load39) + (load42 * load49) + (load43 * load48) + (load33 * load38) + (load44 * load47) + (load34 * load37);
        long load318 = (load3(bArr4, 21) & 2097151) + (load3 * load311) + (load4 * load310) + (load32 * load410) + (load42 * load39) + (load43 * load49) + (load33 * load48) + (load44 * load38) + (load34 * load47) + (load35 * load37);
        ...
        long load418 = (load4(bArr4, 28) >> 7) + (load3 * load412) + (load4 * load312) + (load32 * load411) + (load42 * load311) + (load43 * load310) + (load33 * load410) + (load44 * load39) + (load34 * load49) + (load35 * load48) + (load45 * load38) + (load36 * load47) + (load37 * load46) + j23;
        long j24 = j - (j23 << 21);
    ...
    private static void reduce(byte[] bArr) {
        ...
        long load410 = ((load4(bArr, 44) >> 5) & 2097151) + j22;
        ...
        long load411 = ((load4(bArr, 10) >> 4) & 2097151) + (j37 * 666643);
        long load412 = ((load4(bArr, 7) >> 7) & 2097151) + (j38 * 666643);
        long j40 = ((j25 - (load410 * 997805)) + (j37 * 136657)) - (j38 * 683901);
        long load310 = ((load3(bArr, 5) >> 2) & 2097151) + (j34 * 666643);
        long load413 = ((load4(bArr, 2) >> 5) & 2097151) + (j35 * 666643);
        long j41 = ((((j9 + (load410 * 470296)) + (j37 * 654183)) - (j38 * 997805)) + (j34 * 136657)) - (j35 * 683901);
        long load311 = (load3(bArr, 0) & 2097151) + (j31 * 666643);
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        int i2 = (b & 255) >> 7;
        int i3 = b - (((-i2) & b) << 1);
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][0], m2427eq(i3, 1));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][1], m2427eq(i3, 2));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][2], m2427eq(i3, 3));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][3], m2427eq(i3, 4));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][4], m2427eq(i3, 5));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][5], m2427eq(i3, 6));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][6], m2427eq(i3, 7));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][7], m2427eq(i3, 8));
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        XYZ xyz3 = partialXYZT.xyz;
        Field25519.mult(xyz3.f5837z, xyz3.f5835x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f5834t, xyzt.f5838t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f5835x, xyzt.xyz.f5837z);
        long[] jArr5 = partialXYZT.xyz.f5835x;
        Field25519.sum(jArr, jArr5, jArr5);
        ...
        long[] jArr6 = xyz5.f5836y;
        Field25519.sum(jArr6, xyz5.f5837z, jArr6);
        Field25519.sub(partialXYZT.xyz.f5837z, jArr, partialXYZT.f5834t);
        long[] jArr7 = partialXYZT.f5834t;
