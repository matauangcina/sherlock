...
public final class C2167m0 {
    /* renamed from: a */
    public static Status m2347a(String str) {
        ...
        return asList.size() > 1 ? m2346b((String) asList.get(0), (String) asList.get(1)) : m2346b((String) asList.get(0), null);
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* renamed from: b */
    private static Status m2346b(String str, String str2) {
        char c;
        int i;
        switch (str.hashCode()) {
            case -2130504259:
