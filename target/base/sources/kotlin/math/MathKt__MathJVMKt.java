...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m3ln(double x) {
        return Math.log(x);
    }
    ...
    /* renamed from: ln */
    private static final float m2ln(float x) {
