...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1463getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m245boximpl(result);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m255unboximpl());
                }
            }
        }
    }
