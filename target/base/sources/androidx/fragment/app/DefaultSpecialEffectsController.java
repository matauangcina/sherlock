...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> operations, boolean isPop) {
        ...
        for (SpecialEffectsController.Operation operation : operations) {
            ...
            switch (C031210.f89xe493b431[operation.getFinalState().ordinal()]) {
                case 1:
                case 2:
                case 3:
    ...
    static /* synthetic */ class C031210 {
        ...
        static {
            ...
            try {
                f89xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f89xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f89xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
