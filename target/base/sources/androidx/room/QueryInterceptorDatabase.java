...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    public void execSQL(final String sql, Object[] bindArgs) {
        Intrinsics.checkNotNullParameter(sql, "sql");
        Intrinsics.checkNotNullParameter(bindArgs, "bindArgs");
        List $this$execSQL_u24lambda_u2411 = CollectionsKt.createListBuilder();
        CollectionsKt.addAll($this$execSQL_u24lambda_u2411, bindArgs);
        final List inputArguments = CollectionsKt.build($this$execSQL_u24lambda_u2411);
        this.queryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.execSQL$lambda$12(QueryInterceptorDatabase.this, sql, inputArguments);
            }
        });
        List $this$toTypedArray$iv = inputArguments;
        this.delegate.execSQL(sql, $this$toTypedArray$iv.toArray(new Object[0]));
    }
