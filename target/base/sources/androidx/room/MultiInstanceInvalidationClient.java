...
public final class MultiInstanceInvalidationClient {
    ...
    public MultiInstanceInvalidationClient(Context context, String name, Intent serviceIntent, InvalidationTracker invalidationTracker, Executor executor) {
        ...
        Collection tableNames = invalidationTracker.getTableIdLookup$room_runtime_release().keySet();
        Collection $this$toTypedArray$iv = tableNames;
        setObserver(new InvalidationTracker.Observer((String[]) $this$toTypedArray$iv.toArray(new String[0])) { // from class: androidx.room.MultiInstanceInvalidationClient.1
            ...
            public void onInvalidated(Set<String> tables) {
                ...
                try {
                    ...
                    if (service != null) {
                        ...
                        service.broadcastInvalidation(MultiInstanceInvalidationClient.this.getClientId(), (String[]) $this$toTypedArray$iv2.toArray(new String[0]));
                    }
