...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round((daysSince2000 - f11J0) - arcLongitude);
        double trueAnomaly2 = meanAnomaly;
        double solarTransitJ2000 = f11J0 + n + arcLongitude + (Math.sin(trueAnomaly2) * 0.0053d) + (Math.sin(2.0d * solarLng) * (-0.0069d));
