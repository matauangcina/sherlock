...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0028R.attr.actionBarSize, 16842841};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!this.mOverlayMode && !stable) {
            ...
            Insets sysWindow = Insets.m168of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + topInset, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0028R.C0031id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0028R.C0031id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0028R.C0031id.action_bar));
        }
    }
