...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0028R.styleable.ButtonBarLayout);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0028R.styleable.ButtonBarLayout, attrs, ta, 0, 0);
        this.mAllowStacking = ta.getBoolean(C0028R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
        if (getOrientation() == 1) {
    ...
    private void setStacked(boolean stacked) {
        if (this.mStacked != stacked) {
            if (!stacked || this.mAllowStacking) {
                ...
                View spacer = findViewById(C0028R.C0031id.spacer);
                if (spacer != null) {
