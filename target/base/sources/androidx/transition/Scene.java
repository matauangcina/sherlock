...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup sceneRoot, int layoutId, Context context) {
        SparseArray<Scene> scenes = (SparseArray) sceneRoot.getTag(C0549R.C0552id.transition_scene_layoutid_cache);
        if (scenes == null) {
            scenes = new SparseArray<>();
            sceneRoot.setTag(C0549R.C0552id.transition_scene_layoutid_cache, scenes);
        }
    ...
    public static void setCurrentScene(ViewGroup sceneRoot, Scene scene) {
        sceneRoot.setTag(C0549R.C0552id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup sceneRoot) {
        return (Scene) sceneRoot.getTag(C0549R.C0552id.transition_current_scene);
    }
