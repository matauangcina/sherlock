...
public final class MetadataItem extends Table {
    ...
    public int m137id() {
        int o = __offset(4);
        if (o != 0) {
            return this.f88bb.getInt(this.bb_pos + o);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        int o = __offset(6);
        return (o == 0 || this.f88bb.get(this.bb_pos + o) == 0) ? false : true;
    }

    public short sdkAdded() {
        int o = __offset(8);
        if (o != 0) {
            return this.f88bb.getShort(this.bb_pos + o);
        }
        return (short) 0;
    }
    ...
    public int codepoints(int j) {
        int o = __offset(16);
        if (o != 0) {
            return this.f88bb.getInt(__vector(o) + (j * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector obj) {
        int o = __offset(16);
        if (o != 0) {
            return obj.__assign(__vector(o), this.f88bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem obj, int j) {
            return obj.__assign(MetadataItem.__indirect(__element(j), this.f82bb), this.f82bb);
        }
    }
}
