...
public final class EncryptedSharedPreferences implements SharedPreferences {
    ...
    private static final class Editor implements SharedPreferences.Editor {
        ...
        private void notifyListeners() {
            ...
            while (it.hasNext()) {
                SharedPreferences.OnSharedPreferenceChangeListener listener = it.next();
    ...
    private Object getDecryptedObject(String key) throws SecurityException {
        ...
        try {
            ...
            switch (C05181.f103xe137dbc3[type.ordinal()]) {
                case 1:
    ...
    public static /* synthetic */ class C05181 {
        ...
        static {
            ...
            try {
                f103xe137dbc3[EncryptedType.INT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f103xe137dbc3[EncryptedType.LONG.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f103xe137dbc3[EncryptedType.FLOAT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f103xe137dbc3[EncryptedType.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f103xe137dbc3[EncryptedType.STRING_SET.ordinal()] = 6;
