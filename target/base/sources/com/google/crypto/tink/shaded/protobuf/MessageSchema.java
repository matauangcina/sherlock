...
public final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForRawMessageInfo(RawMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        while (i27 < length) {
            ...
            if (fieldType >= 51) {
                ...
                java.lang.reflect.Field field = reflectField(messageClass, (String) messageInfoObjects[objectsPosition2]);
            ...
            buffer[bufferIndex2] = ((result22 & 512) != 0 ? ENFORCE_UTF8_MASK : 0) | ((result22 & 256) != 0 ? REQUIRED_MASK : 0) | (fieldType << 20) | fieldOffset;
    ...
    */
    static <T> com.google.crypto.tink.shaded.protobuf.MessageSchema<T> newSchemaForMessageInfo(com.google.crypto.tink.shaded.protobuf.StructuralMessageInfo r32, com.google.crypto.tink.shaded.protobuf.NewInstanceSchema r33, com.google.crypto.tink.shaded.protobuf.ListFieldSchema r34, com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema<?, ?> r35, com.google.crypto.tink.shaded.protobuf.ExtensionSchema<?> r36, com.google.crypto.tink.shaded.protobuf.MapFieldSchema r37) {
        /*
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            int presenceMask = 0;
            if (fieldType > 17) {
                if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.m34id() && fieldType <= FieldType.SINT64_LIST_PACKED.m34id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            if (fieldType >= FieldType.DOUBLE_LIST_PACKED.m34id() && fieldType <= FieldType.SINT64_LIST_PACKED.m34id()) {
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:193:0x06fa A[Catch: all -> 0x0764, TRY_LEAVE, TryCatch #1 {all -> 0x0764, blocks: (B:174:0x06b6, B:191:0x06f4, B:193:0x06fa, B:206:0x0730, B:207:0x0735, B:71:0x0136, B:72:0x014a, B:73:0x0160, B:74:0x0176, B:75:0x018c, B:76:0x01a2, B:78:0x01ac, B:81:0x01b3, B:82:0x01bd, B:83:0x01ce, B:84:0x01e4, B:85:0x01f5, B:86:0x020a, B:87:0x0213, B:88:0x0229, B:89:0x023f, B:90:0x0255, B:91:0x026b, B:92:0x0281, B:93:0x0297, B:94:0x02ad), top: B:232:0x06b6 }] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private <UT, UB, ET extends com.google.crypto.tink.shaded.protobuf.FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema<UT, UB> r21, com.google.crypto.tink.shaded.protobuf.ExtensionSchema<ET> r22, T r23, com.google.crypto.tink.shaded.protobuf.Reader r24, com.google.crypto.tink.shaded.protobuf.ExtensionRegistryLite r25) throws java.io.IOException {
        /*
        ...
        switch (fieldType) {
            ...
            case 59:
                if (wireType != 2) {
                    ...
                    } else if ((typeAndOffset & ENFORCE_UTF8_MASK) != 0 && !Utf8.isValidUtf8(data, position9, position9 + length)) {
                    ...
                    switch (fieldType) {
                        ...
                        case 8:
                            ...
                            if (currentPresenceFieldOffset2 == 2) {
                                if ((typeAndOffset4 & ENFORCE_UTF8_MASK) == 0) {
