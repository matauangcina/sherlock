...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap x0, C11861 x1) {
        this(x0);
    }
    ...
    public static boolean isValidType(final WireFormat.FieldType type, final Object value) {
        ...
        switch (C11861.$SwitchMap$com$google$protobuf$WireFormat$JavaType[type.getJavaType().ordinal()]) {
            case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C11861 {
    ...
    static void writeElementNoTag(final CodedOutputStream output, final WireFormat.FieldType type, final Object value) throws IOException {
        switch (C11861.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
