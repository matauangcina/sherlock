...
public final class EllipticCurves {
    ...
    public static byte[] ecdsaDer2Ieee(byte[] der, int ieeeLength) throws GeneralSecurityException {
        ...
        int length = der[1] & UByte.MAX_VALUE;
        int offset = 2;
        if (length >= 128) {
            offset = 2 + 1;
        }
    ...
    public static int encodingSizeInBytes(EllipticCurve curve, PointFormatType format) throws GeneralSecurityException {
        ...
        switch (C12591.f339xc12280c3[format.ordinal()]) {
            case 1:
    ...
    public static /* synthetic */ class C12591 {
        ...
        static {
            ...
            try {
                f338x7c2ee98b[CurveType.NIST_P384.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f338x7c2ee98b[CurveType.NIST_P521.ordinal()] = 3;
            ...
            try {
                f339xc12280c3[PointFormatType.DO_NOT_USE_CRUNCHY_UNCOMPRESSED.ordinal()] = 2;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f339xc12280c3[PointFormatType.COMPRESSED.ordinal()] = 3;
    ...
    public static ECParameterSpec getCurveSpec(CurveType curve) throws NoSuchAlgorithmException {
        switch (C12591.f338x7c2ee98b[curve.ordinal()]) {
            case 1:
