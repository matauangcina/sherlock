...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    boolean set = false;
                    switch (C135134.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()]) {
                        case 1:
                            if (in.nextInt() != 0) {
                                set = true;
                                break;
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public JsonElement read(JsonReader in) throws IOException {
                ...
                switch (C135134.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C135134 {
            ...
            try {
                for (final Field field : classOfT.getDeclaredFields()) {
                    if (field.isEnumConstant()) {
                        ...
                        String name = r5.name();
                        SerializedName annotation = (SerializedName) field.getAnnotation(SerializedName.class);
                        if (annotation != null) {
