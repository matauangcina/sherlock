...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C0616R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }

    @Override // android.view.View
    protected void onFinishInflate() {
        super.onFinishInflate();
        this.messageView = (TextView) findViewById(C0616R.C0619id.snackbar_text);
        this.actionView = (Button) findViewById(C0616R.C0619id.snackbar_action);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0616R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0616R.dimen.design_snackbar_padding_vertical);
