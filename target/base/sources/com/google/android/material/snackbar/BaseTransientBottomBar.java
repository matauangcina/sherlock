...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0616R.attr.snackbarStyle};
    ...
    public BaseTransientBottomBar(Context context, ViewGroup parent, View content, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.animationSlideDuration = MotionUtils.resolveThemeDuration(context, C0616R.attr.motionDurationLong2, 250);
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, C0616R.attr.motionDurationLong2, DEFAULT_ANIMATION_FADE_IN_DURATION);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(context, C0616R.attr.motionDurationMedium1, DEFAULT_ANIMATION_FADE_OUT_DURATION);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context, C0616R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context, C0616R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
        this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context, C0616R.attr.motionEasingEmphasizedInterpolator, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
    }
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0616R.layout.mtrl_layout_snackbar : C0616R.layout.design_layout_snackbar;
    }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context2.obtainStyledAttributes(attrs, C0616R.styleable.SnackbarLayout);
            if (a.hasValue(C0616R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, a.getDimensionPixelSize(C0616R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = a.getInt(C0616R.styleable.SnackbarLayout_animationMode, 0);
            if (a.hasValue(C0616R.styleable.SnackbarLayout_shapeAppearance) || a.hasValue(C0616R.styleable.SnackbarLayout_shapeAppearanceOverlay)) {
                this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, 0, 0).build();
            }
            this.backgroundOverlayColorAlpha = a.getFloat(C0616R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, a, C0616R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(a.getInt(C0616R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = a.getFloat(C0616R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            this.maxWidth = a.getDimensionPixelSize(C0616R.styleable.SnackbarLayout_android_maxWidth, -1);
            this.maxInlineActionWidth = a.getDimensionPixelSize(C0616R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
            a.recycle();
        ...
        private Drawable createThemedBackground() {
            int backgroundColor = MaterialColors.layer(this, C0616R.attr.colorSurface, C0616R.attr.colorOnSurface, getBackgroundOverlayColorAlpha());
    ...
    public static GradientDrawable createGradientDrawableBackground(int backgroundColor, Resources resources) {
        float cornerRadius = resources.getDimension(C0616R.dimen.mtrl_snackbar_background_corner_radius);
