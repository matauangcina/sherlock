...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0616R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0616R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L2e:
            ...
            int[] r2 = com.google.android.material.C0616R.styleable.AppBarLayout
            int[] r5 = new int[r7]
            r0 = r10
            r1 = r11
            r3 = r12
            android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r1 = com.google.android.material.C0616R.styleable.AppBarLayout_android_background
            android.graphics.drawable.Drawable r1 = r0.getDrawable(r1)
            androidx.core.view.ViewCompat.setBackground(r9, r1)
            int r1 = com.google.android.material.C0616R.styleable.AppBarLayout_liftOnScrollColor
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList(r10, r0, r1)
            if (r1 == 0) goto L4e
            goto L4f
        L4e:
            r8 = r7
        L4f:
            ...
            android.content.res.ColorStateList r2 = com.google.android.material.drawable.DrawableUtils.getColorStateListOrNull(r2)
            if (r2 == 0) goto L6c
            com.google.android.material.shape.MaterialShapeDrawable r3 = new com.google.android.material.shape.MaterialShapeDrawable
            r3.<init>()
            r3.setFillColor(r2)
            if (r1 == 0) goto L69
            r9.initializeLiftOnScrollWithColor(r3, r2, r1)
            goto L6c
        L69:
            r9.initializeLiftOnScrollWithElevation(r10, r3)
        L6c:
            int r3 = com.google.android.material.C0616R.attr.motionDurationMedium2
            android.content.res.Resources r4 = r9.getResources()
            int r5 = com.google.android.material.C0616R.integer.app_bar_elevation_anim_duration
            int r4 = r4.getInteger(r5)
            int r3 = com.google.android.material.motion.MotionUtils.resolveThemeDuration(r10, r3, r4)
            long r3 = (long) r3
            r9.liftOnScrollColorDuration = r3
            int r3 = com.google.android.material.C0616R.attr.motionEasingStandardInterpolator
            android.animation.TimeInterpolator r4 = com.google.android.material.animation.AnimationUtils.LINEAR_INTERPOLATOR
            android.animation.TimeInterpolator r3 = com.google.android.material.motion.MotionUtils.resolveThemeInterpolator(r10, r3, r4)
            r9.liftOnScrollColorInterpolator = r3
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_expanded
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto L9a
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_expanded
            boolean r3 = r0.getBoolean(r3, r7)
            r9.setExpanded(r3, r7, r7)
        L9a:
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_elevation
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lac
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_elevation
            int r3 = r0.getDimensionPixelSize(r3, r7)
            float r3 = (float) r3
            com.google.android.material.appbar.ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(r9, r3)
        Lac:
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lbe
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r3 = r0.getBoolean(r3, r7)
            r9.setKeyboardNavigationCluster(r3)
        Lbe:
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lcf
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r3 = r0.getBoolean(r3, r7)
            r9.setTouchscreenBlocksFocus(r3)
        Lcf:
            android.content.res.Resources r3 = r9.getResources()
            int r4 = com.google.android.material.C0616R.dimen.design_appbar_elevation
            float r3 = r3.getDimension(r4)
            r9.appBarElevation = r3
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_liftOnScroll
            boolean r3 = r0.getBoolean(r3, r7)
            r9.liftOnScroll = r3
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r3 = r0.getResourceId(r3, r6)
            r9.liftOnScrollTargetViewId = r3
            int r3 = com.google.android.material.C0616R.styleable.AppBarLayout_statusBarForeground
            android.graphics.drawable.Drawable r3 = r0.getDrawable(r3)
            r9.setStatusBarForeground(r3)
            r0.recycle()
            com.google.android.material.appbar.AppBarLayout$1 r3 = new com.google.android.material.appbar.AppBarLayout$1
            r3.<init>()
            androidx.core.view.ViewCompat.setOnApplyWindowInsetsListener(r9, r3)
            return
        */
    ...
    private void initializeLiftOnScrollWithColor(final MaterialShapeDrawable background, final ColorStateList originalBackgroundColor, final ColorStateList liftOnScrollColor) {
        final Integer colorSurface = MaterialColors.getColorOrNull(getContext(), C0616R.attr.colorSurface);
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m128x91f594d8(originalBackgroundColor, liftOnScrollColor, background, colorSurface, valueAnimator);
            }
        };
    ...
    public /* synthetic */ void m128x91f594d8(ColorStateList originalBackgroundColor, ColorStateList liftOnScrollColor, MaterialShapeDrawable background, Integer colorSurface, ValueAnimator valueAnimator) {
        Integer num;
        ...
        if (this.statusBarForeground != null && (num = this.statusBarForegroundOriginalColor) != null && num.equals(colorSurface)) {
    ...
    private void initializeLiftOnScrollWithElevation(Context context, final MaterialShapeDrawable background) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m127x84b6053(background, valueAnimator);
            }
        };
        ViewCompat.setBackground(this, background);
    }
    ...
    public /* synthetic */ void m127x84b6053(MaterialShapeDrawable background, ValueAnimator valueAnimator) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0616R.attr.state_liftable : -C0616R.attr.state_liftable;
        extraStates[1] = (this.liftable && this.lifted) ? C0616R.attr.state_lifted : -C0616R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0616R.attr.state_collapsible : -C0616R.attr.state_collapsible;
        extraStates[3] = (this.liftable && this.lifted) ? C0616R.attr.state_collapsed : -C0616R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.scrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0616R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0616R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int scrollEffectInt = a.getInt(C0616R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0);
            setScrollEffect(scrollEffectInt);
            if (a.hasValue(C0616R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0616R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0616R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0616R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
