...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, null, C0616R.attr.materialTimePickerStyle, C0616R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes(null, C0616R.styleable.MaterialTimePicker, C0616R.attr.materialTimePickerStyle, C0616R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C0616R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C0616R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int backgroundColor = a.getColor(C0616R.styleable.MaterialTimePicker_backgroundTint, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup root = (ViewGroup) layoutInflater.inflate(C0616R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) root.findViewById(C0616R.C0619id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) root.findViewById(C0616R.C0619id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C0616R.C0619id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C0616R.C0619id.header_title);
        ...
        Button okButton = (Button) root.findViewById(C0616R.C0619id.material_timepicker_ok_button);
        ...
        Button button = (Button) root.findViewById(C0616R.C0619id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.this.m40xac73da03();
                }
            }, 100L);
        }
    }
    ...
    public /* synthetic */ void m40xac73da03() {
        TimePickerPresenter timePickerPresenter = this.activePresenter;
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0616R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0616R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C0616R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;
