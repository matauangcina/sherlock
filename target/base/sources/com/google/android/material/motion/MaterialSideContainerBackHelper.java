...
public class MaterialSideContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    public MaterialSideContainerBackHelper(View view) {
        ...
        this.maxScaleXDistanceShrink = resources.getDimension(C0616R.dimen.m3_back_progress_side_container_max_scale_x_distance_shrink);
        this.maxScaleXDistanceGrow = resources.getDimension(C0616R.dimen.m3_back_progress_side_container_max_scale_x_distance_grow);
        this.maxScaleYDistance = resources.getDimension(C0616R.dimen.m3_back_progress_side_container_max_scale_y_distance);
    }
