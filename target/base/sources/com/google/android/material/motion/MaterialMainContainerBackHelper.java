...
public class MaterialMainContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    public MaterialMainContainerBackHelper(View view) {
        ...
        this.minEdgeGap = resources.getDimension(C0616R.dimen.m3_back_progress_main_container_min_edge_gap);
        this.maxTranslationY = resources.getDimension(C0616R.dimen.m3_back_progress_main_container_max_translation_y);
    }
