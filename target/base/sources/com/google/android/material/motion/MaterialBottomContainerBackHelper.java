...
public class MaterialBottomContainerBackHelper extends MaterialBackAnimationHelper<View> {
    ...
    public MaterialBottomContainerBackHelper(View view) {
        ...
        this.maxScaleXDistance = resources.getDimension(C0616R.dimen.m3_back_progress_bottom_container_max_scale_x_distance);
        this.maxScaleYDistance = resources.getDimension(C0616R.dimen.m3_back_progress_bottom_container_max_scale_y_distance);
    }
