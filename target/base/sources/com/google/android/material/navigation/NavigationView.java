...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    private static final int DEF_STYLE_RES = C0616R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0616R.attr.navigationViewStyle);
    }
    ...
    */
    ...
    private boolean hasShapeAppearance(TintTypedArray a) {
        return a.hasValue(C0616R.styleable.NavigationView_itemShapeAppearance) || a.hasValue(C0616R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private Drawable createDefaultItemBackground(TintTypedArray a) {
        ColorStateList fillColor = MaterialResources.getColorStateList(getContext(), a, C0616R.styleable.NavigationView_itemShapeFillColor);
    ...
    private Drawable createDefaultItemDrawable(TintTypedArray a, ColorStateList fillColor) {
        int shapeAppearanceResId = a.getResourceId(C0616R.styleable.NavigationView_itemShapeAppearance, 0);
        int shapeAppearanceOverlayResId = a.getResourceId(C0616R.styleable.NavigationView_itemShapeAppearanceOverlay, 0);
        ...
        int insetLeft = a.getDimensionPixelSize(C0616R.styleable.NavigationView_itemShapeInsetStart, 0);
        int insetTop = a.getDimensionPixelSize(C0616R.styleable.NavigationView_itemShapeInsetTop, 0);
        int insetRight = a.getDimensionPixelSize(C0616R.styleable.NavigationView_itemShapeInsetEnd, 0);
        int insetBottom = a.getDimensionPixelSize(C0616R.styleable.NavigationView_itemShapeInsetBottom, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.navigation.NavigationView$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                NavigationView.this.m74xb790515(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m74xb790515(Canvas x$0) {
