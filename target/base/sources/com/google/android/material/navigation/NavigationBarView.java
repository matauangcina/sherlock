...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C0616R.styleable.NavigationBarView, defStyleAttr, defStyleRes, C0616R.styleable.NavigationBarView_itemTextAppearanceInactive, C0616R.styleable.NavigationBarView_itemTextAppearanceActive);
        ...
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemIconTint)) {
            createNavigationBarMenuView.setIconTintList(attributes.getColorStateList(C0616R.styleable.NavigationBarView_itemIconTint));
        } else {
            createNavigationBarMenuView.setIconTintList(createNavigationBarMenuView.createDefaultColorStateList(16842808));
        }
        setItemIconSize(attributes.getDimensionPixelSize(C0616R.styleable.NavigationBarView_itemIconSize, getResources().getDimensionPixelSize(C0616R.dimen.mtrl_navigation_bar_item_default_icon_size)));
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemTextAppearanceInactive)) {
            setItemTextAppearanceInactive(attributes.getResourceId(C0616R.styleable.NavigationBarView_itemTextAppearanceInactive, 0));
        }
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemTextAppearanceActive)) {
            setItemTextAppearanceActive(attributes.getResourceId(C0616R.styleable.NavigationBarView_itemTextAppearanceActive, 0));
        }
        boolean isBold = attributes.getBoolean(C0616R.styleable.NavigationBarView_itemTextAppearanceActiveBoldEnabled, true);
        setItemTextAppearanceActiveBoldEnabled(isBold);
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemTextColor)) {
            setItemTextColor(attributes.getColorStateList(C0616R.styleable.NavigationBarView_itemTextColor));
        }
        ...
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemPaddingTop)) {
            setItemPaddingTop(attributes.getDimensionPixelSize(C0616R.styleable.NavigationBarView_itemPaddingTop, 0));
        }
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_itemPaddingBottom)) {
            setItemPaddingBottom(attributes.getDimensionPixelSize(C0616R.styleable.NavigationBarView_itemPaddingBottom, 0));
        }
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_activeIndicatorLabelPadding)) {
            setActiveIndicatorLabelPadding(attributes.getDimensionPixelSize(C0616R.styleable.NavigationBarView_activeIndicatorLabelPadding, 0));
        }
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_elevation)) {
            setElevation(attributes.getDimensionPixelSize(C0616R.styleable.NavigationBarView_elevation, 0));
        }
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context2, attributes, C0616R.styleable.NavigationBarView_backgroundTint);
        DrawableCompat.setTintList(getBackground().mutate(), backgroundTint);
        setLabelVisibilityMode(attributes.getInteger(C0616R.styleable.NavigationBarView_labelVisibilityMode, -1));
        int itemBackground = attributes.getResourceId(C0616R.styleable.NavigationBarView_itemBackground, 0);
        if (itemBackground != 0) {
            createNavigationBarMenuView.setItemBackgroundRes(itemBackground);
        } else {
            setItemRippleColor(MaterialResources.getColorStateList(context2, attributes, C0616R.styleable.NavigationBarView_itemRippleColor));
        }
        int activeIndicatorStyleResId = attributes.getResourceId(C0616R.styleable.NavigationBarView_itemActiveIndicatorStyle, 0);
        if (activeIndicatorStyleResId != 0) {
            setItemActiveIndicatorEnabled(true);
            TypedArray activeIndicatorAttributes = context2.obtainStyledAttributes(activeIndicatorStyleResId, C0616R.styleable.NavigationBarActiveIndicator);
            int itemActiveIndicatorWidth = activeIndicatorAttributes.getDimensionPixelSize(C0616R.styleable.NavigationBarActiveIndicator_android_width, 0);
            setItemActiveIndicatorWidth(itemActiveIndicatorWidth);
            int itemActiveIndicatorWidth2 = C0616R.styleable.NavigationBarActiveIndicator_android_height;
            int itemActiveIndicatorHeight = activeIndicatorAttributes.getDimensionPixelSize(itemActiveIndicatorWidth2, 0);
            setItemActiveIndicatorHeight(itemActiveIndicatorHeight);
            int itemActiveIndicatorHeight2 = C0616R.styleable.NavigationBarActiveIndicator_marginHorizontal;
            int itemActiveIndicatorMarginHorizontal = activeIndicatorAttributes.getDimensionPixelOffset(itemActiveIndicatorHeight2, 0);
            setItemActiveIndicatorMarginHorizontal(itemActiveIndicatorMarginHorizontal);
            ColorStateList itemActiveIndicatorColor = MaterialResources.getColorStateList(context2, activeIndicatorAttributes, C0616R.styleable.NavigationBarActiveIndicator_android_color);
            setItemActiveIndicatorColor(itemActiveIndicatorColor);
            int itemActiveIndicatorMarginHorizontal2 = C0616R.styleable.NavigationBarActiveIndicator_shapeAppearance;
        ...
        if (attributes.hasValue(C0616R.styleable.NavigationBarView_menu)) {
            inflateMenu(attributes.getResourceId(C0616R.styleable.NavigationBarView_menu, 0));
        }
        attributes.recycle();
