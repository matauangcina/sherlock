...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C0616R.C0619id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C0616R.C0619id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C0616R.C0619id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C0616R.C0619id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C0616R.C0619id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0616R.C0619id.navigation_bar_item_large_label_view);
        this.largeLabel = textView2;
        setBackgroundResource(getItemBackgroundResId());
        this.itemPaddingTop = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        this.itemPaddingBottom = viewGroup.getPaddingBottom();
        this.activeIndicatorLabelPadding = getResources().getDimensionPixelSize(C0616R.dimen.m3_navigation_item_active_indicator_label_padding);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float newProgress) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0616R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0616R.attr.motionDurationLong2, getResources().getInteger(C0616R.integer.material_motion_duration_long_1)));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        infoCompat.setRoleDescription(getResources().getString(C0616R.string.item_view_role_description));
    }
    ...
    protected int getItemBackgroundResId() {
        return C0616R.C0618drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C0616R.dimen.mtrl_navigation_bar_item_default_margin;
    }
