...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0616R.attr.motionDurationMedium4, getResources().getInteger(C0616R.integer.material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0616R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
    ...
    public void buildMenuView() {
        ...
        for (int i = 0; i < this.menu.size(); i++) {
            ...
            if (i4 != -1) {
                child.setActiveIndicatorLabelPadding(i4);
            }
