...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0616R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0616R.attr.badgeStyle;
    ...
    private boolean isAnchorViewWrappedInCompatParent() {
        ...
        return customBadgeAnchorParent != null && customBadgeAnchorParent.getId() == C0616R.C0619id.mtrl_anchor_parent;
    }
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (anchorViewParent == null || anchorViewParent.getId() != C0616R.C0619id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            ...
            frameLayout.setId(C0616R.C0619id.mtrl_anchor_parent);
    ...
    private String getTextBadgeText() {
        ...
        if (text != null && text.length() > maxCharacterCount) {
            ...
            return String.format(context.getString(C0616R.string.m3_exceed_max_badge_text_suffix), text.substring(0, maxCharacterCount - 1), DEFAULT_EXCEED_MAX_BADGE_TEXT_SUFFIX);
        }
        return text;
    }
    ...
    private String getNumberBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C0616R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
