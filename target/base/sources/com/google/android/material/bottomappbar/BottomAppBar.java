...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0616R.style.Widget_MaterialComponents_BottomAppBar;
    private static final int FAB_ALIGNMENT_ANIM_DURATION_ATTR = C0616R.attr.motionDurationLong2;
    private static final int FAB_ALIGNMENT_ANIM_EASING_ATTR = C0616R.attr.motionEasingEmphasizedInterpolator;
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0616R.attr.bottomAppBarStyle);
    }
    ...
    protected int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int fabAlignmentMode, boolean fabAttached) {
        ...
        if (this.menuAlignmentMode == 1 || (fabAlignmentMode == 1 && fabAttached)) {
            ...
            if (getNavigationIcon() == null) {
                int horizontalMargin = getResources().getDimensionPixelOffset(C0616R.dimen.m3_bottomappbar_horizontal_padding);
                ...
                public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        if (child.fabAnchorMode == 1) {
                            ...
                            int bottomMargin = child.getResources().getDimensionPixelOffset(C0616R.dimen.mtrl_bottomappbar_fab_bottom_margin);
            ...
            if (dependentView != null && !ViewCompat.isLaidOut(dependentView)) {
                ...
                if (dependentView instanceof FloatingActionButton) {
                    ...
                    if (fab.getShowMotionSpec() == null) {
                        fab.setShowMotionSpecResource(C0616R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (fab.getHideMotionSpec() == null) {
                        fab.setHideMotionSpecResource(C0616R.animator.mtrl_fab_hide_motion_spec);
                    }
