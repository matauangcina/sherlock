...
public final class QuantizerWu implements Quantizer {
    ...
    double variance(Box cube) {
        ...
        double xx = ((((((this.moments[getIndex(cube.f156r1, cube.f154g1, cube.f152b1)] - this.moments[getIndex(cube.f156r1, cube.f154g1, cube.f151b0)]) - this.moments[getIndex(cube.f156r1, cube.f153g0, cube.f152b1)]) + this.moments[getIndex(cube.f156r1, cube.f153g0, cube.f151b0)]) - this.moments[getIndex(cube.f155r0, cube.f154g1, cube.f152b1)]) + this.moments[getIndex(cube.f155r0, cube.f154g1, cube.f151b0)]) + this.moments[getIndex(cube.f155r0, cube.f153g0, cube.f152b1)]) - this.moments[getIndex(cube.f155r0, cube.f153g0, cube.f151b0)];
    ...
    Boolean cut(Box one, Box two) {
        ...
        MaximizeResult maxRResult = maximize(one, Direction.RED, one.f155r0 + 1, one.f156r1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxGResult = maximize(one, Direction.GREEN, one.f153g0 + 1, one.f154g1, wholeR, wholeG, wholeB, wholeW);
        MaximizeResult maxBResult = maximize(one, Direction.BLUE, one.f151b0 + 1, one.f152b1, wholeR, wholeG, wholeB, wholeW);
        ...
        two.f156r1 = one.f156r1;
        two.f154g1 = one.f154g1;
        two.f152b1 = one.f152b1;
        switch (C06931.f150x8739cebf[cutDirection.ordinal()]) {
            case 1:
                one.f156r1 = maxRResult.cutLocation;
                two.f155r0 = one.f156r1;
                two.f153g0 = one.f153g0;
                two.f151b0 = one.f151b0;
                break;
            case 2:
                one.f154g1 = maxGResult.cutLocation;
                two.f155r0 = one.f155r0;
                two.f153g0 = one.f154g1;
                two.f151b0 = one.f151b0;
                break;
            case 3:
                one.f152b1 = maxBResult.cutLocation;
                two.f155r0 = one.f155r0;
                two.f153g0 = one.f153g0;
                two.f151b0 = one.f152b1;
                break;
        }
        one.vol = (one.f156r1 - one.f155r0) * (one.f154g1 - one.f153g0) * (one.f152b1 - one.f151b0);
        two.vol = (two.f156r1 - two.f155r0) * (two.f154g1 - two.f153g0) * (two.f152b1 - two.f151b0);
        return true;
    }
    ...
    public static /* synthetic */ class C06931 {
        ...
        static final /* synthetic */ int[] f150x8739cebf;
        ...
        static {
            ...
            try {
                f150x8739cebf[Direction.GREEN.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f150x8739cebf[Direction.BLUE.ordinal()] = 3;
    ...
    static int volume(Box cube, int[] moment) {
        return ((((((moment[getIndex(cube.f156r1, cube.f154g1, cube.f152b1)] - moment[getIndex(cube.f156r1, cube.f154g1, cube.f151b0)]) - moment[getIndex(cube.f156r1, cube.f153g0, cube.f152b1)]) + moment[getIndex(cube.f156r1, cube.f153g0, cube.f151b0)]) - moment[getIndex(cube.f155r0, cube.f154g1, cube.f152b1)]) + moment[getIndex(cube.f155r0, cube.f154g1, cube.f151b0)]) + moment[getIndex(cube.f155r0, cube.f153g0, cube.f152b1)]) - moment[getIndex(cube.f155r0, cube.f153g0, cube.f151b0)];
    }

    static int bottom(Box cube, Direction direction, int[] moment) {
        switch (C06931.f150x8739cebf[direction.ordinal()]) {
            case 1:
                return (((-moment[getIndex(cube.f155r0, cube.f154g1, cube.f152b1)]) + moment[getIndex(cube.f155r0, cube.f154g1, cube.f151b0)]) + moment[getIndex(cube.f155r0, cube.f153g0, cube.f152b1)]) - moment[getIndex(cube.f155r0, cube.f153g0, cube.f151b0)];
            case 2:
                return (((-moment[getIndex(cube.f156r1, cube.f153g0, cube.f152b1)]) + moment[getIndex(cube.f156r1, cube.f153g0, cube.f151b0)]) + moment[getIndex(cube.f155r0, cube.f153g0, cube.f152b1)]) - moment[getIndex(cube.f155r0, cube.f153g0, cube.f151b0)];
            case 3:
                return (((-moment[getIndex(cube.f156r1, cube.f154g1, cube.f151b0)]) + moment[getIndex(cube.f156r1, cube.f153g0, cube.f151b0)]) + moment[getIndex(cube.f155r0, cube.f154g1, cube.f151b0)]) - moment[getIndex(cube.f155r0, cube.f153g0, cube.f151b0)];
            default:
    ...
    static int top(Box cube, Direction direction, int position, int[] moment) {
        switch (C06931.f150x8739cebf[direction.ordinal()]) {
            case 1:
                return ((moment[getIndex(position, cube.f154g1, cube.f152b1)] - moment[getIndex(position, cube.f154g1, cube.f151b0)]) - moment[getIndex(position, cube.f153g0, cube.f152b1)]) + moment[getIndex(position, cube.f153g0, cube.f151b0)];
            case 2:
                return ((moment[getIndex(cube.f156r1, position, cube.f152b1)] - moment[getIndex(cube.f156r1, position, cube.f151b0)]) - moment[getIndex(cube.f155r0, position, cube.f152b1)]) + moment[getIndex(cube.f155r0, position, cube.f151b0)];
            case 3:
                return ((moment[getIndex(cube.f156r1, cube.f154g1, position)] - moment[getIndex(cube.f156r1, cube.f153g0, position)]) - moment[getIndex(cube.f155r0, cube.f154g1, position)]) + moment[getIndex(cube.f155r0, cube.f153g0, position)];
            default:
                throw new IllegalArgumentException("unexpected direction " + direction);
        }
    }
