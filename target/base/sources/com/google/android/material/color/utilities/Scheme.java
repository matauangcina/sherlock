...
public class Scheme {
    ...
    public static Scheme light(int argb) {
        return lightFromCorePalette(CorePalette.m121of(argb));
    }

    public static Scheme dark(int argb) {
        return darkFromCorePalette(CorePalette.m121of(argb));
    }
    ...
    private static Scheme lightFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f145a1.tone(40)).withOnPrimary(core.f145a1.tone(100)).withPrimaryContainer(core.f145a1.tone(90)).withOnPrimaryContainer(core.f145a1.tone(10)).withSecondary(core.f146a2.tone(40)).withOnSecondary(core.f146a2.tone(100)).withSecondaryContainer(core.f146a2.tone(90)).withOnSecondaryContainer(core.f146a2.tone(10)).withTertiary(core.f147a3.tone(40)).withOnTertiary(core.f147a3.tone(100)).withTertiaryContainer(core.f147a3.tone(90)).withOnTertiaryContainer(core.f147a3.tone(10)).withError(core.error.tone(40)).withOnError(core.error.tone(100)).withErrorContainer(core.error.tone(90)).withOnErrorContainer(core.error.tone(10)).withBackground(core.f148n1.tone(99)).withOnBackground(core.f148n1.tone(10)).withSurface(core.f148n1.tone(99)).withOnSurface(core.f148n1.tone(10)).withSurfaceVariant(core.f149n2.tone(90)).withOnSurfaceVariant(core.f149n2.tone(30)).withOutline(core.f149n2.tone(50)).withOutlineVariant(core.f149n2.tone(80)).withShadow(core.f148n1.tone(0)).withScrim(core.f148n1.tone(0)).withInverseSurface(core.f148n1.tone(20)).withInverseOnSurface(core.f148n1.tone(95)).withInversePrimary(core.f145a1.tone(80));
    }

    private static Scheme darkFromCorePalette(CorePalette core) {
        return new Scheme().withPrimary(core.f145a1.tone(80)).withOnPrimary(core.f145a1.tone(20)).withPrimaryContainer(core.f145a1.tone(30)).withOnPrimaryContainer(core.f145a1.tone(90)).withSecondary(core.f146a2.tone(80)).withOnSecondary(core.f146a2.tone(20)).withSecondaryContainer(core.f146a2.tone(30)).withOnSecondaryContainer(core.f146a2.tone(90)).withTertiary(core.f147a3.tone(80)).withOnTertiary(core.f147a3.tone(20)).withTertiaryContainer(core.f147a3.tone(30)).withOnTertiaryContainer(core.f147a3.tone(90)).withError(core.error.tone(80)).withOnError(core.error.tone(20)).withErrorContainer(core.error.tone(30)).withOnErrorContainer(core.error.tone(80)).withBackground(core.f148n1.tone(10)).withOnBackground(core.f148n1.tone(90)).withSurface(core.f148n1.tone(10)).withOnSurface(core.f148n1.tone(90)).withSurfaceVariant(core.f149n2.tone(30)).withOnSurfaceVariant(core.f149n2.tone(80)).withOutline(core.f149n2.tone(60)).withOutlineVariant(core.f149n2.tone(30)).withShadow(core.f148n1.tone(0)).withScrim(core.f148n1.tone(0)).withInverseSurface(core.f148n1.tone(90)).withInverseOnSurface(core.f148n1.tone(20)).withInversePrimary(core.f145a1.tone(40));
    }
