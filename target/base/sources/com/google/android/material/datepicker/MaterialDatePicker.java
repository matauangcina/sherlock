...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, C0616R.attr.materialCalendarStyle, C0616R.style.Widget_MaterialComponents_MaterialCalendar);
        TypedArray a = context.obtainStyledAttributes(null, C0616R.styleable.MaterialCalendar, C0616R.attr.materialCalendarStyle, C0616R.style.Widget_MaterialComponents_MaterialCalendar);
        int backgroundColor = a.getColor(C0616R.styleable.MaterialCalendar_backgroundTint, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int layout = this.fullscreen ? C0616R.layout.mtrl_picker_fullscreen : C0616R.layout.mtrl_picker_dialog;
        ...
        if (this.fullscreen) {
            View frame = root.findViewById(C0616R.C0619id.mtrl_calendar_frame);
            frame.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View pane = root.findViewById(C0616R.C0619id.mtrl_calendar_main_pane);
            pane.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) root.findViewById(C0616R.C0619id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C0616R.C0619id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) root.findViewById(C0616R.C0619id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) root.findViewById(C0616R.C0619id.confirm_button);
        ...
        Button cancelButton = (Button) root.findViewById(C0616R.C0619id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C0616R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final View headerLayout = requireView().findViewById(C0616R.C0619id.fullscreen_header);
    ...
    private void startPickerFragment() {
        ...
        fragmentTransaction.replace(C0616R.C0619id.mtrl_calendar_frame, this.pickerFragment);
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                MaterialDatePicker.this.m77x8a93f18a(view);
            }
        });
    }
    ...
    public /* synthetic */ void m77x8a93f18a(View v) {
    ...
    private void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.inputMode == 1) {
            contentDescription = toggle.getContext().getString(C0616R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C0616R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0616R.C0618drawable.material_ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0616R.C0618drawable.material_ic_edit_black_24dp));
    ...
    public static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0616R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        int calendarStyle = MaterialAttributes.resolveOrThrow(context, C0616R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName());
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int padding = resources.getDimensionPixelOffset(C0616R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.current().daysInWeek;
        int dayWidth = resources.getDimensionPixelSize(C0616R.dimen.mtrl_calendar_day_width);
        int horizontalSpace = resources.getDimensionPixelOffset(C0616R.dimen.mtrl_calendar_month_horizontal_padding);
