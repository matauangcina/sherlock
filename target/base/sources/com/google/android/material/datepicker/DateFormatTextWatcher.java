...
public abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String formatHint, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints constraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0616R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DateFormatTextWatcher.this.m78x5657fb8e(formatHint);
            }
        };
    }
    ...
    public /* synthetic */ void m78x5657fb8e(String formatHint) {
        TextInputLayout textLayout = this.textInputLayout;
        DateFormat df = this.dateFormat;
        Context context = textLayout.getContext();
        String invalidFormat = context.getString(C0616R.string.mtrl_picker_invalid_format);
        String useLine = String.format(context.getString(C0616R.string.mtrl_picker_invalid_format_use), sanitizeDateString(formatHint));
        String exampleLine = String.format(context.getString(C0616R.string.mtrl_picker_invalid_format_example), sanitizeDateString(df.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
    ...
    private Runnable createRangeErrorCallback(final long milliseconds) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                DateFormatTextWatcher.this.m79x14d77527(milliseconds);
            }
        };
    }
    ...
    public /* synthetic */ void m79x14d77527(long milliseconds) {
