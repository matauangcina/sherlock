...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            float height = this.operation.f166y - this.startY;
            float width = this.operation.f165x - this.startX;
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f166y - this.startY) / (this.operation.f165x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                double length1 = Math.hypot(this.operation1.f165x - this.startX, this.operation1.f166y - this.startY);
                double length22 = Math.hypot(this.operation2.f165x - this.operation1.f165x, this.operation2.f166y - this.operation1.f166y);
                ...
                this.renderMatrix.set(transform);
                this.renderMatrix.preTranslate(this.operation1.f165x, this.operation1.f166y);
                this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f166y - this.startY) / (this.operation1.f165x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f166y - this.operation1.f166y) / (this.operation2.f165x - this.operation1.f165x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix transform, Path path) {
            ...
            path.lineTo(this.f165x, this.f166y);
