...
public class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public /* synthetic */ void m53xfc81bd94(View view) {
    ...
    public /* synthetic */ void m52x7ae2c173(View view, boolean hasFocus) {
    ...
    public ClearTextEndIconDelegate(EndCompoundLayout endLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda3
            ...
            public final void onClick(View view) {
                ClearTextEndIconDelegate.this.m53xfc81bd94(view);
            }
        };
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void onFocusChange(View view, boolean z) {
                ClearTextEndIconDelegate.this.m52x7ae2c173(view, z);
            }
        };
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0616R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endLayout.getContext(), C0616R.attr.motionDurationShort3, DEFAULT_ANIMATION_SCALE_DURATION);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endLayout.getContext(), C0616R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
        ...
        if (editText != null) {
            editText.post(new Runnable() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ClearTextEndIconDelegate.this.m51x26d8c5f4();
                }
            });
        }
    }
    ...
    public /* synthetic */ void m51x26d8c5f4() {
        animateIcon(true);
    }
    ...
    public int getIconDrawableResId() {
        return C0616R.C0618drawable.mtrl_ic_cancel;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C0616R.string.clear_text_end_icon_content_description;
    }
    ...
    private ValueAnimator getAlphaAnimator(float... values) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ClearTextEndIconDelegate.this.m55xa5c23ba8(valueAnimator);
            }
        });
        return animator;
    }
    ...
    public /* synthetic */ void m55xa5c23ba8(ValueAnimator animation) {
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ClearTextEndIconDelegate.this.m54x3819711b(valueAnimator);
            }
        });
        return animator;
    }
    ...
    public /* synthetic */ void m54x3819711b(ValueAnimator animation) {
