...
public class EndCompoundLayout extends LinearLayout {
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray a) {
        ...
        CheckableImageButton createIconView = createIconView(this, layoutInflater, C0616R.C0619id.text_input_error_icon);
        this.errorIconView = createIconView;
        CheckableImageButton createIconView2 = createIconView(frameLayout, layoutInflater, C0616R.C0619id.text_input_end_icon);
    ...
    private CheckableImageButton createIconView(ViewGroup root, LayoutInflater inflater, int id) {
        CheckableImageButton iconView = (CheckableImageButton) inflater.inflate(C0616R.layout.design_text_input_end_icon, root, false);
        iconView.setId(id);
    ...
    private void initErrorIconView(TintTypedArray a) {
        if (a.hasValue(C0616R.styleable.TextInputLayout_errorIconTint)) {
            this.errorIconTintList = MaterialResources.getColorStateList(getContext(), a, C0616R.styleable.TextInputLayout_errorIconTint);
        }
        if (a.hasValue(C0616R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(a.getInt(C0616R.styleable.TextInputLayout_errorIconTintMode, -1), null);
        }
        if (a.hasValue(C0616R.styleable.TextInputLayout_errorIconDrawable)) {
            setErrorIconDrawable(a.getDrawable(C0616R.styleable.TextInputLayout_errorIconDrawable));
        }
        this.errorIconView.setContentDescription(getResources().getText(C0616R.string.error_icon_content_description));
    ...
    private void initEndIconView(TintTypedArray a) {
        if (!a.hasValue(C0616R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (a.hasValue(C0616R.styleable.TextInputLayout_endIconTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), a, C0616R.styleable.TextInputLayout_endIconTint);
            }
            if (a.hasValue(C0616R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(a.getInt(C0616R.styleable.TextInputLayout_endIconTintMode, -1), null);
            }
        }
        if (a.hasValue(C0616R.styleable.TextInputLayout_endIconMode)) {
            setEndIconMode(a.getInt(C0616R.styleable.TextInputLayout_endIconMode, 0));
            if (a.hasValue(C0616R.styleable.TextInputLayout_endIconContentDescription)) {
                setEndIconContentDescription(a.getText(C0616R.styleable.TextInputLayout_endIconContentDescription));
            }
            setEndIconCheckable(a.getBoolean(C0616R.styleable.TextInputLayout_endIconCheckable, true));
        } else if (a.hasValue(C0616R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (a.hasValue(C0616R.styleable.TextInputLayout_passwordToggleTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), a, C0616R.styleable.TextInputLayout_passwordToggleTint);
            }
            if (a.hasValue(C0616R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(a.getInt(C0616R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
            }
            setEndIconMode(a.getBoolean(C0616R.styleable.TextInputLayout_passwordToggleEnabled, false) ? 1 : 0);
            setEndIconContentDescription(a.getText(C0616R.styleable.TextInputLayout_passwordToggleContentDescription));
        }
        setEndIconMinSize(a.getDimensionPixelSize(C0616R.styleable.TextInputLayout_endIconMinSize, getResources().getDimensionPixelSize(C0616R.dimen.mtrl_min_touch_target_size)));
        if (a.hasValue(C0616R.styleable.TextInputLayout_endIconScaleType)) {
            setEndIconScaleType(IconHelper.convertScaleType(a.getInt(C0616R.styleable.TextInputLayout_endIconScaleType, -1)));
        }
    }

    private void initSuffixTextView(TintTypedArray a) {
        this.suffixTextView.setVisibility(8);
        this.suffixTextView.setId(C0616R.C0619id.textinput_suffix_text);
        ...
        setSuffixTextAppearance(a.getResourceId(C0616R.styleable.TextInputLayout_suffixTextAppearance, 0));
        if (a.hasValue(C0616R.styleable.TextInputLayout_suffixTextColor)) {
            setSuffixTextColor(a.getColorStateList(C0616R.styleable.TextInputLayout_suffixTextColor));
        }
        setSuffixText(a.getText(C0616R.styleable.TextInputLayout_suffixText));
    }
    ...
    public void updateSuffixTextViewPadding() {
        ...
        ViewCompat.setPaddingRelative(this.suffixTextView, getContext().getResources().getDimensionPixelSize(C0616R.dimen.material_input_text_to_prefix_suffix_padding), this.textInputLayout.editText.getPaddingTop(), endPadding, this.textInputLayout.editText.getPaddingBottom());
    }
    ...
    public static class EndIconDelegates {
        ...
        EndIconDelegates(EndCompoundLayout endLayout, TintTypedArray a) {
            ...
            this.customEndIconDrawableId = a.getResourceId(C0616R.styleable.TextInputLayout_endIconDrawable, 0);
            this.passwordIconDrawableId = a.getResourceId(C0616R.styleable.TextInputLayout_passwordToggleDrawable, 0);
        }
