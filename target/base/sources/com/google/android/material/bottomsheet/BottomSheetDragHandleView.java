...
public class BottomSheetDragHandleView extends AppCompatImageView implements AccessibilityManager.AccessibilityStateChangeListener {
    private static final int DEF_STYLE_RES = C0616R.style.Widget_Material3_BottomSheet_DragHandle;
    ...
    public BottomSheetDragHandleView(Context context, AttributeSet attrs) {
        this(context, attrs, C0616R.attr.bottomSheetDragHandleStyle);
    }

    public BottomSheetDragHandleView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(MaterialThemeOverlay.wrap(context, attrs, defStyleAttr, DEF_STYLE_RES), attrs, defStyleAttr);
        this.clickToExpandActionLabel = getResources().getString(C0616R.string.bottomsheet_action_expand);
        this.clickToCollapseActionLabel = getResources().getString(C0616R.string.bottomsheet_action_collapse);
        this.clickFeedback = getResources().getString(C0616R.string.bottomsheet_drag_handle_clicked);
    ...
    public void onBottomSheetStateChanged(int state) {
        ...
        ViewCompat.replaceAccessibilityAction(this, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_CLICK, this.clickToExpand ? this.clickToExpandActionLabel : this.clickToCollapseActionLabel, new AccessibilityViewCommand() { // from class: com.google.android.material.bottomsheet.BottomSheetDragHandleView$$ExternalSyntheticLambda0
            ...
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return BottomSheetDragHandleView.this.m126xa7b4c95f(view, commandArguments);
            }
        });
    }
    ...
    public /* synthetic */ boolean m126xa7b4c95f(View v, AccessibilityViewCommand.CommandArguments args) {
