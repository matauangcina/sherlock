...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean expand) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.internal.ExpandCollapseAnimationHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ExpandCollapseAnimationHelper.this.m76xeb41e2ac(bounds, valueAnimator);
            }
        });
        ...
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m75of(expand, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animator;
    }
    ...
    public /* synthetic */ void m76xeb41e2ac(Rect bounds, ValueAnimator valueAnimator) {
    ...
    private Animator getExpandedViewChildrenAlphaAnimator(boolean expand) {
        ...
        animator.setDuration(this.duration);
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m75of(expand, AnimationUtils.LINEAR_INTERPOLATOR));
        return animator;
    }
