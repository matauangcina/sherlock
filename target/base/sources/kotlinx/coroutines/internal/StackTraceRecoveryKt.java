...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m246constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m246constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m249exceptionOrNullimpl(obj) == null) {
            obj4 = obj;
        }
        baseContinuationImplClassName = (String) obj4;
        try {
            Result.Companion companion3 = Result.Companion;
            obj2 = Result.m246constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m246constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m249exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
    ...
    private static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m15to(cause, currentTrace);
            }
            return TuplesKt.m15to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m15to(e, new StackTraceElement[0]);
    }
