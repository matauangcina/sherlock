    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        while (true) {
            ...
            if (!(state instanceof CompletedContinuation)) {
                if (C0133xc40028dd.m174m(_state$FU, this, state, new CompletedContinuation(state, null, null, null, cause, 14, null))) {
                    return;
                }
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (state instanceof Active) {
                if (C0133xc40028dd.m174m(_state$FU, this, state, cancelHandler)) {
                    return;
                }
                ...
                if (C0133xc40028dd.m174m(_state$FU, this, state, update2)) {
                    return;
                }
            }
        }
