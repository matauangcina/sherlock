...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (newInstance != null) {
            m246constructorimpl = Result.m246constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            if (Result.m252isFailureimpl(m246constructorimpl)) {
                m246constructorimpl = null;
            }
            return (Function1) m246constructorimpl;
        }
    ...
    private final <R> List<R> dumpCoroutinesInfoImpl(final Function2<? super CoroutineOwner<?>, ? super CoroutineContext, ? extends R> function2) {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith($this$sortedBy$iv, new C1389x8808a3e8()), new Function1<CoroutineOwner<?>, R>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfoImpl$1$3
    ...
    public final List<DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        try {
            ...
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith($this$sortedBy$iv$iv, new C1389x8808a3e8()), new Function1<CoroutineOwner<?>, DebugCoroutineInfo>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesInfo$$inlined$dumpCoroutinesInfoImpl$1
                @Override // kotlin.jvm.functions.Function1
    ...
    public final List<DebuggerInfo> dumpDebuggerInfo() {
        ...
        try {
            ...
            Sequence $this$sortedBy$iv$iv = CollectionsKt.asSequence(debugProbesImpl.getCapturedCoroutines());
            return SequencesKt.toList(SequencesKt.mapNotNull(SequencesKt.sortedWith($this$sortedBy$iv$iv, new C1389x8808a3e8()), new Function1<CoroutineOwner<?>, DebuggerInfo>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpDebuggerInfo$$inlined$dumpCoroutinesInfoImpl$1
                @Override // kotlin.jvm.functions.Function1
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> list) {
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) m246constructorimpl;
        if (actualTrace == null) {
            return list;
        }
        int index$iv = 0;
    ...
    private final Pair<Integer, Integer> findContinuationStartIndex(int indexOfResumeWith, StackTraceElement[] actualTrace, List<StackTraceElement> list) {
        for (int i = 0; i < 3; i++) {
            ...
            if (result != -1) {
                return TuplesKt.m15to(Integer.valueOf(result), Integer.valueOf(it));
            }
        }
        return TuplesKt.m15to(-1, 0);
    }
