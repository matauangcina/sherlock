...
public final class C1458xd7c321ea<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public C1458xd7c321ea(Flow[] flowArr, Continuation continuation, Function7 function7) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C1458xd7c321ea c1458xd7c321ea = new C1458xd7c321ea(this.$flows, continuation, this.$transform$inlined);
        c1458xd7c321ea.L$0 = obj;
        return c1458xd7c321ea;
    }
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C1458xd7c321ea) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* loaded from: classes5.dex */
    public static final class C14591 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function7 $transform$inlined;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C14591(Continuation continuation, Function7 function7) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C14591 c14591 = new C14591(continuation, this.$transform$inlined);
            c14591.L$0 = flowCollector;
            c14591.L$1 = objArr;
            return c14591.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CombineKt.combineInternal($this$flow, flowArr, nullArrayFactory$FlowKt__ZipKt, new C14591(null, this.$transform$inlined), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
