...
public final class C1456xd7c321e9<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public C1456xd7c321e9(Flow[] flowArr, Continuation continuation, Function6 function6) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C1456xd7c321e9 c1456xd7c321e9 = new C1456xd7c321e9(this.$flows, continuation, this.$transform$inlined);
        c1456xd7c321e9.L$0 = obj;
        return c1456xd7c321e9;
    }
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        return ((C1456xd7c321e9) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* loaded from: classes5.dex */
    public static final class C14571 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        final /* synthetic */ Function6 $transform$inlined;
        private /* synthetic */ Object L$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C14571(Continuation continuation, Function6 function6) {
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            C14571 c14571 = new C14571(continuation, this.$transform$inlined);
            c14571.L$0 = flowCollector;
            c14571.L$1 = objArr;
            return c14571.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (CombineKt.combineInternal($this$flow, flowArr, nullArrayFactory$FlowKt__ZipKt, new C14571(null, this.$transform$inlined), this) != coroutine_suspended) {
                    break;
                } else {
                    return coroutine_suspended;
                }
