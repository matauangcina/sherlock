...
@Metadata(m23d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u008a@"}, m22d2 = {"<anonymous>", "", "T1", "T2", "R", "Lkotlinx/coroutines/channels/ProducerScope;", ""}, m21k = 3, m20mv = {1, 6, 0}, m18xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m14c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1", m13f = "Combine.kt", m12i = {}, m11l = {92}, m10m = "invokeSuspend", m9n = {}, m8s = {})
...
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    /* loaded from: classes5.dex */
    public static final class C14761<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C14761(ProducerScope<Object> producerScope) {
        ...
        */
        public final java.lang.Object emit(T2 r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
            ...
            L49:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$second$1.C14761.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (this.$flow2.collect(new C14761($this$produce), this) != coroutine_suspended) {
                    break;
                } else {
