...
@Metadata(m23d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u008a@"}, m22d2 = {"<anonymous>", "", "T", "value", "Lkotlinx/coroutines/channels/ChannelResult;", ""}, m21k = 3, m20mv = {1, 6, 0}, m18xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
@DebugMetadata(m14c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2", m13f = "Delay.kt", m12i = {0}, m11l = {243}, m10m = "invokeSuspend", m9n = {"$this$onFailure_u2dWpGqRn0$iv"}, m8s = {"L$0"})
...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1781invokeWpGqRn0(channelResult.m1770unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1781invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m1758boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m1770unboximpl = ((ChannelResult) this.L$0).m1770unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m1770unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m1770unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m1770unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m1762exceptionOrNullimpl(m1770unboximpl);
                    if (it != null) {
                        throw it;
                    }
