...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.Companion.m1771closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.Companion.m1773successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m1771closedJP2dKIU(closed.closeCause);
    }
}
