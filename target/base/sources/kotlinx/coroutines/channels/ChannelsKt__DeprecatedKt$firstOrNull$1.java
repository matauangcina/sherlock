...
@DebugMetadata(m14c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m13f = "Deprecated.kt", m12i = {0, 0}, m11l = {75}, m10m = "firstOrNull", m9n = {"$this$consume$iv", "iterator"}, m8s = {"L$0", "L$1"})
