...
@DebugMetadata(m14c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m13f = "Deprecated.kt", m12i = {0, 0, 1, 1}, m11l = {487, 278}, m10m = "toChannel", m9n = {"destination", "$this$consume$iv$iv", "destination", "$this$consume$iv$iv"}, m8s = {"L$0", "L$1", "L$0", "L$1"})
