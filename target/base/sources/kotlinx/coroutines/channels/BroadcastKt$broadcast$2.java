...
@DebugMetadata(m14c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m13f = "Broadcast.kt", m12i = {0, 1}, m11l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_BASELINE_TO_BOTTOM_OF, ConstraintLayout.LayoutParams.Table.LAYOUT_MARGIN_BASELINE}, m10m = "invokeSuspend", m9n = {"$this$broadcast", "$this$broadcast"}, m8s = {"L$0", "L$0"})
