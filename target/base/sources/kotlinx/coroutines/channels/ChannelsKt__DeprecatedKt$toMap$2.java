...
@DebugMetadata(m14c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m13f = "Deprecated.kt", m12i = {0, 0}, m11l = {487}, m10m = "toMap", m9n = {"destination", "$this$consume$iv$iv"}, m8s = {"L$0", "L$1"})
