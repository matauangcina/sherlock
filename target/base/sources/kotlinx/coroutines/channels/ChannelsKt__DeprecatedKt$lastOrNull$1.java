...
@DebugMetadata(m14c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", m13f = "Deprecated.kt", m12i = {0, 0, 1, 1, 1}, m11l = {123, 126}, m10m = "lastOrNull", m9n = {"$this$consume$iv", "iterator", "$this$consume$iv", "iterator", "last"}, m8s = {"L$0", "L$1", "L$0", "L$1", "L$2"})
