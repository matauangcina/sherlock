...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0163R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0163R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0163R.C0165drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0163R.C0166id.notification_main_column);
            outerView.addView(C0163R.C0166id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0163R.C0166id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0163R.C0166id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0163R.C0166id.title, 8);
            outerView.setViewVisibility(C0163R.C0166id.text2, 8);
            outerView.setViewVisibility(C0163R.C0166id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0163R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0163R.dimen.notification_top_pad_large_text);
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (Message compatMessage : this.mMessages) {
                    if (Build.VERSION.SDK_INT >= 28) {
                        ...
                        frameworkMessage = new Notification.MessagingStyle.Message(text2, timestamp, androidPerson);
                    } else {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0163R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0163R.C0166id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0163R.C0166id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0163R.C0166id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0163R.C0166id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0163R.layout.notification_action_tombstone : C0163R.layout.notification_action);
            button.setImageViewBitmap(C0163R.C0166id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0163R.C0164color.notification_action_color_filter)));
            button.setTextViewText(C0163R.C0166id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0163R.C0166id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0163R.C0166id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m44clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            public BubbleMetadata build() {
                ...
                BubbleMetadata data = new BubbleMetadata(this.mPendingIntent, this.mDeleteIntent, this.mIcon, this.mDesiredHeight, this.mDesiredHeightResId, this.mFlags);
                return data;
            }
