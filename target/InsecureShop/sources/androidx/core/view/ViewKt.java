...
public final class ViewKt {
    ...
    public static /* synthetic */ void updatePaddingRelative$default(View updatePaddingRelative, int start, int top, int end, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
            start = updatePaddingRelative.getPaddingStart();
        }
        if ((i & 2) != 0) {
            top = updatePaddingRelative.getPaddingTop();
        }
        if ((i & 4) != 0) {
            end = updatePaddingRelative.getPaddingEnd();
        }
        if ((i & 8) != 0) {
            bottom = updatePaddingRelative.getPaddingBottom();
        }
        Intrinsics.checkParameterIsNotNull(updatePaddingRelative, "$this$updatePaddingRelative");
        updatePaddingRelative.setPaddingRelative(start, top, end, bottom);
    }

    public static final void updatePaddingRelative(View updatePaddingRelative, int start, int top, int end, int bottom) {
        Intrinsics.checkParameterIsNotNull(updatePaddingRelative, "$this$updatePaddingRelative");
        updatePaddingRelative.setPaddingRelative(start, top, end, bottom);
    }

    public static /* synthetic */ void updatePadding$default(View updatePadding, int left, int top, int right, int bottom, int i, Object obj) {
        if ((i & 1) != 0) {
            left = updatePadding.getPaddingLeft();
        }
        if ((i & 2) != 0) {
            top = updatePadding.getPaddingTop();
        }
        if ((i & 4) != 0) {
            right = updatePadding.getPaddingRight();
        }
        if ((i & 8) != 0) {
            bottom = updatePadding.getPaddingBottom();
        }
        Intrinsics.checkParameterIsNotNull(updatePadding, "$this$updatePadding");
        updatePadding.setPadding(left, top, right, bottom);
    }

    public static final void updatePadding(View updatePadding, int left, int top, int right, int bottom) {
        Intrinsics.checkParameterIsNotNull(updatePadding, "$this$updatePadding");
        updatePadding.setPadding(left, top, right, bottom);
    }

    public static final void setPadding(View setPadding, int size) {
        Intrinsics.checkParameterIsNotNull(setPadding, "$this$setPadding");
        setPadding.setPadding(size, size, size, size);
    }

    public static final Runnable postDelayed(View postDelayed, long delayInMillis, final Function0<Unit> action) {
    ...
    public static final Runnable postOnAnimationDelayed(View postOnAnimationDelayed, long delayInMillis, final Function0<Unit> action) {
        ...
        postOnAnimationDelayed.postOnAnimationDelayed(runnable, delayInMillis);
        return runnable;
    }
    ...
    public static final Bitmap drawToBitmap(View drawToBitmap, Bitmap.Config config) {
        ...
        Bitmap $this$applyCanvas$iv = Bitmap.createBitmap(drawToBitmap.getWidth(), drawToBitmap.getHeight(), config);
        ...
        c$iv.translate(-drawToBitmap.getScrollX(), -drawToBitmap.getScrollY());
        drawToBitmap.draw(c$iv);
    ...
    public static final void setVisible(View isVisible, boolean value) {
        Intrinsics.checkParameterIsNotNull(isVisible, "$this$isVisible");
        isVisible.setVisibility(value ? 0 : 8);
    }
    ...
    public static final void setInvisible(View isInvisible, boolean value) {
        Intrinsics.checkParameterIsNotNull(isInvisible, "$this$isInvisible");
        isInvisible.setVisibility(value ? 4 : 0);
    }
    ...
    public static final void setGone(View isGone, boolean value) {
        Intrinsics.checkParameterIsNotNull(isGone, "$this$isGone");
        isGone.setVisibility(value ? 8 : 0);
    }
    ...
    public static final void updateLayoutParams(View updateLayoutParams, Function1<? super ViewGroup.LayoutParams, Unit> block) {
        ...
        ViewGroup.LayoutParams params$iv = updateLayoutParams.getLayoutParams();
        if (params$iv == null) {
            throw new TypeCastException("null cannot be cast to non-null type android.view.ViewGroup.LayoutParams");
        }
        block.invoke(params$iv);
        updateLayoutParams.setLayoutParams(params$iv);
    }
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View updateLayoutParams, Function1<? super T, Unit> block) {
        ...
        block.invoke(params);
        updateLayoutParams.setLayoutParams(params);
    }
    ...
    public static final int getMarginStart(View marginStart) {
        ...
        ViewGroup.LayoutParams lp = marginStart.getLayoutParams();
    ...
    public static final int getMarginEnd(View marginEnd) {
        ...
        ViewGroup.LayoutParams lp = marginEnd.getLayoutParams();
        if (lp instanceof ViewGroup.MarginLayoutParams) {
