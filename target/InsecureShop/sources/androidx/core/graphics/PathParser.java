    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            while (k2 < val.length) {
                if (c == 'A') {
                    ...
                    k = k2;
                    drawArc(path, currentX2, currentY4, val[k2 + 5] + currentX2, val[k2 + 6] + currentY4, val[k2 + 0], val[k2 + 1], val[k2 + 2], val[k2 + 3] != 0.0f, val[k2 + 4] != 0.0f);
                    currentX2 += val[k + 5];
                    currentY2 = currentY4 + val[k + 6];
                    ...
                    float ctrlPointY3 = currentY5 + val[k2 + 3];
                    currentX2 += val[k2 + 4];
                    ctrlPointX2 = ctrlPointX3;
                    ctrlPointY2 = ctrlPointY3;
                    k = k2;
                    currentY2 = val[k2 + 5] + currentY5;
                } else if (c == 'h') {
                    ...
                    float ctrlPointY4 = currentY6 + val[k2 + 1];
                    currentX2 += val[k2 + 2];
                    ctrlPointX2 = ctrlPointX4;
                    ctrlPointY2 = ctrlPointY4;
                    k = k2;
                    currentY2 = val[k2 + 3] + currentY6;
                } else if (c == 'v') {
                    ...
                    float f = reflectiveCtrlPointY2;
                    float reflectiveCtrlPointY6 = currentY2;
                    path.rCubicTo(reflectiveCtrlPointX2, f, val[k2 + 0], val[k2 + 1], val[k2 + 2], val[k2 + 3]);
                    float ctrlPointX5 = val[k2 + 0] + currentX2;
                    float ctrlPointY5 = reflectiveCtrlPointY6 + val[k2 + 1];
                    currentX2 += val[k2 + 2];
                    ctrlPointX2 = ctrlPointX5;
                    ctrlPointY2 = ctrlPointY5;
                    k = k2;
                    currentY2 = val[k2 + 3] + reflectiveCtrlPointY6;
                } else if (c != 't') {
                    k = k2;
                } else {
                    ...
                    path.rQuadTo(reflectiveCtrlPointX7, reflectiveCtrlPointY7, val[k2 + 0], val[k2 + 1]);
                    float ctrlPointX6 = currentX2 + reflectiveCtrlPointX7;
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (i < numSegments) {
                ...
                double cosEta13 = cy + (e1x2 * sinTheta * cosEta2) + (b * cosTheta * sinEta2);
