...
public final class SparseArrayKt {
    ...
    public static final <T> boolean contains(SparseArray<T> contains, int key) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.indexOfKey(key) >= 0;
    }

    public static final <T> void set(SparseArray<T> set, int key, T t) {
    ...
    public static final <T> boolean containsKey(SparseArray<T> containsKey, int key) {
    ...
    public static final <T> T getOrDefault(SparseArray<T> getOrDefault, int key, T t) {
        Intrinsics.checkParameterIsNotNull(getOrDefault, "$this$getOrDefault");
        T t2 = getOrDefault.get(key);
        return t2 != null ? t2 : t;
    }

    public static final <T> T getOrElse(SparseArray<T> getOrElse, int key, Function0<? extends T> defaultValue) {
    ...
    public static final <T> boolean remove(SparseArray<T> remove, int key, T t) {
