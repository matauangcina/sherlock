...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C0143R.C0144color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0143R.C0144color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0143R.dimen.cardview_compat_inset_shadow);
