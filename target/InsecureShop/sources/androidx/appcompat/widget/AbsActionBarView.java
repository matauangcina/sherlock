...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (context.getTheme().resolveAttribute(C0040R.attr.actionBarPopupTheme, tv, true) && tv.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0040R.styleable.ActionBar, C0040R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0040R.styleable.ActionBar_height, 0));
        a.recycle();
