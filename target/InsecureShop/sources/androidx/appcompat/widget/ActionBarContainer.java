...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0040R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0040R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0040R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0040R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0040R.C0043id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0040R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0040R.C0043id.action_bar);
        this.mContextView = findViewById(C0040R.C0043id.action_context_bar);
    }
