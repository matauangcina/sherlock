...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0040R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0040R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        int minSmallestWidthCascading = this.mContext.getResources().getDimensionPixelSize(C0040R.dimen.abc_cascading_menus_min_smallest_width);
