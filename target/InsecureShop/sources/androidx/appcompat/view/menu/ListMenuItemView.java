...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0040R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0040R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0040R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0040R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0040R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0040R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0040R.attr.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(C0040R.C0043id.title);
        this.mTitleView = textView;
        int i = this.mTextAppearance;
        if (i != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0040R.C0043id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0040R.C0043id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0040R.C0043id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0040R.C0043id.content);
    }
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0040R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0040R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0040R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
