...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0384R.C0387id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0384R.C0387id.media_actions, button);
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0384R.C0387id.end_padder, 8);
                view.setViewVisibility(C0384R.C0387id.cancel_action, 0);
                view.setOnClickPendingIntent(C0384R.C0387id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0384R.C0387id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0384R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0384R.C0387id.end_padder, 0);
                view.setViewVisibility(C0384R.C0387id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0384R.layout.notification_media_action);
            button.setImageViewResource(C0384R.C0387id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0384R.C0387id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0384R.C0387id.action0, action.getTitle());
            }
            return button;
        }

        int getContentViewLayoutResource() {
            return C0384R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0384R.C0387id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    RemoteViews button = generateMediaActionButton(this.mBuilder.mActions.get(i));
                    big.addView(C0384R.C0387id.media_actions, button);
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0384R.C0387id.cancel_action, 0);
                big.setInt(C0384R.C0387id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0384R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0384R.C0387id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0384R.C0387id.cancel_action, 8);
            }
            return big;
        }

        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0384R.layout.notification_template_big_media_narrow : C0384R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            return this.mBuilder.getContentView() != null ? C0384R.layout.notification_template_media_custom : super.getContentViewLayoutResource();
        }
        ...
        @Override // androidx.media.app.NotificationCompat.MediaStyle
        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0384R.layout.notification_template_big_media_narrow_custom : C0384R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0384R.C0385color.notification_material_background_media_default_color);
            }
            views.setInt(C0384R.C0387id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
