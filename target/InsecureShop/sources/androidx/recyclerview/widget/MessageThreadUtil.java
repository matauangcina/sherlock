...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes.dex */
    class C04251 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem msg = C04251.this.mQueue.next();
                while (msg != null) {
                    int i = msg.what;
                    if (i == 1) {
                        C04251.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                    } else if (i == 2) {
                        TileList.Tile<T> tile = (TileList.Tile) msg.data;
                        C04251.this.val$callback.addTile(msg.arg1, tile);
                    } else if (i == 3) {
                        C04251.this.val$callback.removeTile(msg.arg1, msg.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                    }
                    msg = C04251.this.mQueue.next();
                }
            }
        };

        C04251(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> callback) {
        return new C04251(callback);
    }

    /* renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    /* loaded from: classes.dex */
    class C04272 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C04272.this.mQueue.next();
                    if (msg != null) {
                        int i = msg.what;
                        if (i == 1) {
                            C04272.this.mQueue.removeMessages(1);
                            C04272.this.val$callback.refresh(msg.arg1);
                        } else if (i == 2) {
                            C04272.this.mQueue.removeMessages(2);
                            C04272.this.mQueue.removeMessages(3);
                            C04272.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                        } else if (i == 3) {
                            C04272.this.val$callback.loadTile(msg.arg1, msg.arg2);
                        } else if (i == 4) {
                            TileList.Tile<T> tile = (TileList.Tile) msg.data;
                            C04272.this.val$callback.recycleTile(tile);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                        }
                    } else {
                        C04272.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C04272(ThreadUtil.BackgroundCallback backgroundCallback) {
