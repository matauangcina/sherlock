...
public class TextViewBindingAdapter {
    ...
    public static void setTextWatcher(TextView view, final BeforeTextChanged before, final OnTextChanged on, final AfterTextChanged after, final InverseBindingListener textAttrChanged) {
        ...
        if (before == null && after == null && on == null && textAttrChanged == null) {
            ...
            newValue = new TextWatcher() { // from class: androidx.databinding.adapters.TextViewBindingAdapter.1
        ...
        TextWatcher oldValue = (TextWatcher) ListenerUtil.trackListener(view, newValue, C0274R.C0277id.textWatcher);
        if (oldValue != null) {
