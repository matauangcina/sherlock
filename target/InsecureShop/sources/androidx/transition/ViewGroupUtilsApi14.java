...
class ViewGroupUtilsApi14 {
    ...
    public static void suppressLayout(ViewGroup group, boolean suppress) {
        ...
        if (suppress) {
            ...
            if (layoutTransition2 != null) {
                ...
                if (layoutTransition2 != sEmptyLayoutTransition) {
                    group.setTag(C0491R.C0494id.transition_layout_save, layoutTransition2);
                }
            }
        ...
        LayoutTransition layoutTransition3 = (LayoutTransition) group.getTag(C0491R.C0494id.transition_layout_save);
        if (layoutTransition3 != null) {
            group.setTag(C0491R.C0494id.transition_layout_save, null);
