...
public abstract class FragmentTransaction {
    ...
    ArrayList<C0309Op> mOps = new ArrayList<>();
    ...
    /* loaded from: classes.dex */
    public static final class C0309Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0309Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0309Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0309Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0309Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0309Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0309Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0309Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0309Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0309Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0309Op(10, fragment, state));
        return this;
    }
