...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int DEF_STYLE_RES = C0630R.style.Widget_Design_BottomSheet_Modal;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0630R.styleable.BottomSheetBehavior_Layout);
        this.shapeThemingEnabled = a.hasValue(C0630R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        boolean hasBackgroundTint = a.hasValue(C0630R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        if (hasBackgroundTint) {
            ColorStateList bottomSheetColor = MaterialResources.getColorStateList(context, a, C0630R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.elevation = a.getDimension(C0630R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        }
        TypedValue value = a.peekValue(C0630R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (value != null && value.data == -1) {
            setPeekHeight(value.data);
        } else {
            setPeekHeight(a.getDimensionPixelSize(C0630R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        }
        setHideable(a.getBoolean(C0630R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setFitToContents(a.getBoolean(C0630R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(a.getBoolean(C0630R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setSaveFlags(a.getInt(C0630R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(a.getFloat(C0630R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, HIDE_THRESHOLD));
        setExpandedOffset(a.getInt(C0630R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = parent.getResources().getDimensionPixelSize(C0630R.dimen.design_bottom_sheet_peek_height_min);
        ...
        if (this.lastNestedScrollDy > 0) {
            ...
            if (top2 == 0) {
                ...
                if (this.fitToContents) {
                    ...
                    } else if (Math.abs(currentTop2 - top5) < Math.abs(currentTop2 - this.collapsedOffset)) {
    ...
    private void createMaterialShapeDrawable(Context context, AttributeSet attrs, boolean hasBackgroundTint, ColorStateList bottomSheetColor) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attrs, C0630R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
