...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public DateFormatTextWatcher(String formatHint, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints constraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0630R.string.mtrl_picker_out_of_range);
    }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        try {
            ...
            String invalidFormat = this.textInputLayout.getContext().getString(C0630R.string.mtrl_picker_invalid_format);
            String useLine = String.format(this.textInputLayout.getContext().getString(C0630R.string.mtrl_picker_invalid_format_use), this.formatHint);
            String exampleLine = String.format(this.textInputLayout.getContext().getString(C0630R.string.mtrl_picker_invalid_format_example), this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())));
