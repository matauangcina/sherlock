...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0630R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0630R.C0632drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0630R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0630R.C0633id.icon);
        this.smallLabel = (TextView) findViewById(C0630R.C0633id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0630R.C0633id.largeLabel);
