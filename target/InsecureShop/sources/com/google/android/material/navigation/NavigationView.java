...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.navigationViewStyle);
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context, attrs, C0630R.styleable.NavigationView, defStyleAttr, C0630R.style.Widget_Design_NavigationView, new int[0]);
        if (a.hasValue(C0630R.styleable.NavigationView_android_background)) {
            ViewCompat.setBackground(this, a.getDrawable(C0630R.styleable.NavigationView_android_background));
        }
        ...
        if (a.hasValue(C0630R.styleable.NavigationView_elevation)) {
            setElevation(a.getDimensionPixelSize(C0630R.styleable.NavigationView_elevation, 0));
        }
        setFitsSystemWindows(a.getBoolean(C0630R.styleable.NavigationView_android_fitsSystemWindows, false));
        this.maxWidth = a.getDimensionPixelSize(C0630R.styleable.NavigationView_android_maxWidth, 0);
        if (a.hasValue(C0630R.styleable.NavigationView_itemIconTint)) {
            itemIconTint = a.getColorStateList(C0630R.styleable.NavigationView_itemIconTint);
        } else {
            itemIconTint = createDefaultColorStateList(16842808);
        }
        boolean textAppearanceSet = false;
        int textAppearance = 0;
        if (a.hasValue(C0630R.styleable.NavigationView_itemTextAppearance)) {
            textAppearance = a.getResourceId(C0630R.styleable.NavigationView_itemTextAppearance, 0);
            textAppearanceSet = true;
        }
        if (a.hasValue(C0630R.styleable.NavigationView_itemIconSize)) {
            setItemIconSize(a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemIconSize, 0));
        }
        ColorStateList itemTextColor = a.hasValue(C0630R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0630R.styleable.NavigationView_itemTextColor) : null;
        if (!textAppearanceSet && itemTextColor == null) {
            itemTextColor = createDefaultColorStateList(16842806);
        }
        Drawable itemBackground = a.getDrawable(C0630R.styleable.NavigationView_itemBackground);
        if (itemBackground == null && hasShapeAppearance(a)) {
            itemBackground = createDefaultItemBackground(a);
        }
        if (a.hasValue(C0630R.styleable.NavigationView_itemHorizontalPadding)) {
            int itemHorizontalPadding = a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemHorizontalPadding, 0);
            this.presenter.setItemHorizontalPadding(itemHorizontalPadding);
        }
        int itemHorizontalPadding2 = C0630R.styleable.NavigationView_itemIconPadding;
        int itemIconPadding = a.getDimensionPixelSize(itemHorizontalPadding2, 0);
        setItemMaxLines(a.getInt(C0630R.styleable.NavigationView_itemMaxLines, 1));
        ...
        if (a.hasValue(C0630R.styleable.NavigationView_menu)) {
            inflateMenu(a.getResourceId(C0630R.styleable.NavigationView_menu, 0));
        }
        if (a.hasValue(C0630R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(a.getResourceId(C0630R.styleable.NavigationView_headerLayout, 0));
        }
        a.recycle();
    ...
    private boolean hasShapeAppearance(TintTypedArray a) {
        return a.hasValue(C0630R.styleable.NavigationView_itemShapeAppearance) || a.hasValue(C0630R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private final Drawable createDefaultItemBackground(TintTypedArray a) {
        int shapeAppearanceResId = a.getResourceId(C0630R.styleable.NavigationView_itemShapeAppearance, 0);
        int shapeAppearanceOverlayResId = a.getResourceId(C0630R.styleable.NavigationView_itemShapeAppearanceOverlay, 0);
        ...
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), a, C0630R.styleable.NavigationView_itemShapeFillColor));
        int insetLeft = a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemShapeInsetStart, 0);
        int insetTop = a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemShapeInsetTop, 0);
        int insetRight = a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemShapeInsetEnd, 0);
        int insetBottom = a.getDimensionPixelSize(C0630R.styleable.NavigationView_itemShapeInsetBottom, 0);
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (getContext().getTheme().resolveAttribute(baseColorThemeAttr, value, true)) {
            ...
            if (getContext().getTheme().resolveAttribute(C0040R.attr.colorPrimary, value, true)) {
        ...
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.google.android.material.navigation.NavigationView.2
            ...
            public void onGlobalLayout() {
                ...
                if ((context instanceof Activity) && Build.VERSION.SDK_INT >= 21) {
                    ...
                    NavigationView.this.setDrawBottomInsetForeground((isBehindSystemNav && hasNonZeroAlpha) ? false : false);
                }
            }
        };
