...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0630R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) inflater.inflate(hasSnackbarButtonStyleAttr(parent.getContext()) ? C0630R.layout.mtrl_layout_snackbar_include : C0630R.layout.design_layout_snackbar_include, parent, false);
