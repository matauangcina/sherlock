...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static {
        ...
        SNACKBAR_STYLE_ATTR = new int[]{C0630R.attr.snackbarStyle};
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public BaseTransientBottomBar(ViewGroup parent, View content, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        if (parent == null) {
    ...
    private Drawable createThemedBackground() {
        int backgroundColor = MaterialColors.layer(this.view, C0630R.attr.colorSurface, C0630R.attr.colorOnSurface, this.view.getBackgroundOverlayColorAlpha());
        float cornerRadius = this.view.getResources().getDimension(C0630R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0630R.layout.mtrl_layout_snackbar : C0630R.layout.design_layout_snackbar;
    }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context2.obtainStyledAttributes(attrs, C0630R.styleable.SnackbarLayout);
            if (a.hasValue(C0630R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, a.getDimensionPixelSize(C0630R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = a.getInt(C0630R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = a.getFloat(C0630R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = a.getFloat(C0630R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            a.recycle();
