...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attrs, defStyleAttr, C0630R.style.Widget_Design_AppBarLayout);
        }
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0630R.styleable.AppBarLayout, defStyleAttr, C0630R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, a.getDrawable(C0630R.styleable.AppBarLayout_android_background));
        ...
        if (a.hasValue(C0630R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0630R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0630R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, a.getDimensionPixelSize(C0630R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0630R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0630R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0630R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0630R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = a.getBoolean(C0630R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = a.getResourceId(C0630R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(a.getDrawable(C0630R.styleable.AppBarLayout_statusBarForeground));
        a.recycle();
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0630R.attr.state_liftable : -C0630R.attr.state_liftable;
        extraStates[1] = (this.liftable && this.lifted) ? C0630R.attr.state_lifted : -C0630R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0630R.attr.state_collapsible : -C0630R.attr.state_collapsible;
        extraStates[3] = (this.liftable && this.lifted) ? C0630R.attr.state_collapsed : -C0630R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted) {
        float appBarElevation = getResources().getDimension(C0630R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration(getResources().getInteger(C0630R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.scrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0630R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0630R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0630R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0630R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0630R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0630R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
