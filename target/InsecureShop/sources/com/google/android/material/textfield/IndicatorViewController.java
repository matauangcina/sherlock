...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputView) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C0630R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            appCompatTextView.setId(C0630R.C0633id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            appCompatTextView.setId(C0630R.C0633id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
