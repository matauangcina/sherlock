...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0630R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.floatingActionButtonStyle);
    }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0630R.styleable.FloatingActionButton, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context2, a, C0630R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0630R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.rippleColor = MaterialResources.getColorStateList(context2, a, C0630R.styleable.FloatingActionButton_rippleColor);
        this.size = a.getInt(C0630R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = a.getDimensionPixelSize(C0630R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = a.getDimensionPixelSize(C0630R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0630R.styleable.FloatingActionButton_elevation, 0.0f);
        float hoveredFocusedTranslationZ = a.getDimension(C0630R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float pressedTranslationZ = a.getDimension(C0630R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = a.getBoolean(C0630R.styleable.FloatingActionButton_useCompatPadding, false);
        int minTouchTargetSize = getResources().getDimensionPixelSize(C0630R.dimen.mtrl_fab_min_touch_target);
        this.maxImageSize = a.getDimensionPixelSize(C0630R.styleable.FloatingActionButton_maxImageSize, 0);
        MotionSpec showMotionSpec = MotionSpec.createFromAttribute(context2, a, C0630R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec hideMotionSpec = MotionSpec.createFromAttribute(context2, a, C0630R.styleable.FloatingActionButton_hideMotionSpec);
        ...
        boolean ensureMinTouchTargetSize = a.getBoolean(C0630R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
        a.recycle();
    ...
    private int getSizeDimension(int size) {
        ...
        if (size != -1) {
            if (size == 1) {
                return res.getDimensionPixelSize(C0630R.dimen.design_fab_size_mini);
            }
            return res.getDimensionPixelSize(C0630R.dimen.design_fab_size_normal);
        }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0630R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = a.getBoolean(C0630R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
            a.recycle();
        }
