...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C0630R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C0630R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0630R.styleable.MaterialCardView, defStyleAttr, DEF_STYLE_RES, new int[0]);
