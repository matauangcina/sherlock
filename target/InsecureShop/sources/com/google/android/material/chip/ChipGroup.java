...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.chipGroupStyle);
    }
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0630R.styleable.ChipGroup, defStyleAttr, C0630R.style.Widget_MaterialComponents_ChipGroup, new int[0]);
        int chipSpacing = a.getDimensionPixelOffset(C0630R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a.getDimensionPixelOffset(C0630R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a.getDimensionPixelOffset(C0630R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        setSingleLine(a.getBoolean(C0630R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(a.getBoolean(C0630R.styleable.ChipGroup_singleSelection, false));
        int checkedChip = a.getResourceId(C0630R.styleable.ChipGroup_checkedChip, -1);
        if (checkedChip != -1) {
