...
public class MaterialCheckBox extends AppCompatCheckBox {
    private static final int DEF_STYLE_RES = C0630R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.checkboxStyle);
    }
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0630R.styleable.MaterialCheckBox, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (attributes.hasValue(C0630R.styleable.MaterialCheckBox_buttonTint)) {
            CompoundButtonCompat.setButtonTintList(this, MaterialResources.getColorStateList(context2, attributes, C0630R.styleable.MaterialCheckBox_buttonTint));
        }
        this.useMaterialThemeColors = attributes.getBoolean(C0630R.styleable.MaterialCheckBox_useMaterialThemeColors, false);
        attributes.recycle();
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int colorControlActivated = MaterialColors.getColor(this, C0630R.attr.colorControlActivated);
            int colorSurface = MaterialColors.getColor(this, C0630R.attr.colorSurface);
            int colorOnSurface = MaterialColors.getColor(this, C0630R.attr.colorOnSurface);
