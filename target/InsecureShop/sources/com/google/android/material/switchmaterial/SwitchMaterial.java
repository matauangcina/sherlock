...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0630R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attrs) {
        this(context, attrs, C0630R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0630R.styleable.SwitchMaterial, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = attributes.getBoolean(C0630R.styleable.SwitchMaterial_useMaterialThemeColors, false);
        attributes.recycle();
    }
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            float thumbElevation = getResources().getDimension(C0630R.dimen.mtrl_switch_thumb_elevation);
