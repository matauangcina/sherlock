...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
        ...
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ...
                    entry.executor.execute(new CallResourceReady(entry.f56cb));
                }
    ...
    void notifyCallbacksOfException() {
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it.hasNext()) {
                    ResourceCallbackAndExecutor entry = it.next();
                    entry.executor.execute(new CallLoadFailed(entry.f56cb));
                }
                decrementPendingCallbacks();
            }
        }
    ...
    public class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f54cb;
        ...
        public void run() {
            synchronized (this.f54cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f54cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f54cb);
                    }
    ...
    public class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f55cb;
        ...
        @Override // java.lang.Runnable
        public void run() {
            synchronized (this.f55cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f55cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f55cb);
                        EngineJob.this.removeCallback(this.f55cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    public static final class ResourceCallbackAndExecutor {
        ...
        public boolean equals(Object o) {
            if (o instanceof ResourceCallbackAndExecutor) {
                ...
                return this.f56cb.equals(other.f56cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f56cb.hashCode();
        }
    }
