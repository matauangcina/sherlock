...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config requested) {
        ...
        int i = C05901.$SwitchMap$android$graphics$Bitmap$Config[requested.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    return i != 4 ? new Bitmap.Config[]{requested} : ALPHA_8_IN_CONFIGS;
                }
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C05901 {
