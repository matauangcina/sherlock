...
interface ImageReader {
    ...
    public static final class InputStreamImageReader implements ImageReader {
        ...
        public InputStreamImageReader(InputStream is, List<ImageHeaderParser> parsers, ArrayPool byteArrayPool) {
    ...
    public static final class ParcelFileDescriptorImageReader implements ImageReader {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public ParcelFileDescriptorImageReader(ParcelFileDescriptor parcelFileDescriptor, List<ImageHeaderParser> parsers, ArrayPool byteArrayPool) {
            this.byteArrayPool = (ArrayPool) Preconditions.checkNotNull(byteArrayPool);
            this.parsers = (List) Preconditions.checkNotNull(parsers);
