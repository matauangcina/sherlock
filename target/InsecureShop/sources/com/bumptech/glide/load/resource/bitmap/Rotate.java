...
public class Rotate extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f65ID = "com.bumptech.glide.load.resource.bitmap.Rotate";
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(f65ID.hashCode(), Util.hashCode(this.degreesToRotate));
    }
