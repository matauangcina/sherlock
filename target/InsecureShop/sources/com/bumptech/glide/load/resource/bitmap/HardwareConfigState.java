...
public final class HardwareConfigState {
    ...
    public boolean isHardwareConfigAllowed(int targetWidth, int targetHeight, boolean isHardwareConfigAllowed, boolean isExifOrientationRequired) {
        int i;
        return isHardwareConfigAllowed && this.isHardwareConfigAllowedByDeviceModel && Build.VERSION.SDK_INT >= 26 && !isExifOrientationRequired && targetWidth >= (i = this.minHardwareDimension) && targetHeight >= i && isFdSizeBelowHardwareLimit();
    }
