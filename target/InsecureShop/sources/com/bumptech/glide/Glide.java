...
public class Glide implements ComponentCallbacks2 {
    ...
    public Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, boolean isLoggingRequestOriginsEnabled, boolean isImageDecoderEnabledForBitmaps) {
        ResourceDecoder<ByteBuffer, Bitmap> byteBufferBitmapDecoder;
        ResourceDecoder<InputStream, Bitmap> streamBitmapDecoder;
        ResourceDrawableDecoder resourceDrawableDecoder;
        BitmapBytesTranscoder bitmapBytesTranscoder;
        this.engine = engine;
        ...
        BitmapBytesTranscoder bitmapBytesTranscoder2 = new BitmapBytesTranscoder();
        ...
        this.glideContext = new GlideContext(context, arrayPool, this.registry, imageViewTargetFactory, defaultRequestOptionsFactory, defaultTransitionOptions, defaultRequestListeners, engine, isLoggingRequestOriginsEnabled, logLevel);
    }
