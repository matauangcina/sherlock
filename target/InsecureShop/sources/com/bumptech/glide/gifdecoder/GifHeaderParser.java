...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f49ix = readShort();
        this.header.currentFrame.f50iy = readShort();
        this.header.currentFrame.f48iw = readShort();
        this.header.currentFrame.f47ih = readShort();
        int packed = read();
