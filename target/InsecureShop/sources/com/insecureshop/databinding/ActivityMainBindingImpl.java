...
public class ActivityMainBindingImpl extends ActivityMainBinding {
    ...
    static {
        ...
        sparseIntArray.put(C0893R.C0896id.container, 1);
        sViewsWithIds.put(C0893R.C0896id.bottom_navigation, 2);
    }
    ...
    private ActivityMainBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (BottomNavigationView) bindings[2], (FrameLayout) bindings[1]);
        this.mDirtyFlags = -1L;
