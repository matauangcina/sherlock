...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m1006constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1051timesmvk6XK0(int $this$times, double duration) {
        return Duration.m1033timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1050timeskIfJnKk(double $this$times, double duration) {
        return Duration.m1032timesimpl(duration, $this$times);
    }
}
