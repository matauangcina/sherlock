...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        public static CoroutineContext plus(CoroutineContext $this, CoroutineContext context) {
            ...
            return context == EmptyCoroutineContext.INSTANCE ? $this : (CoroutineContext) context.fold($this, new Function2<CoroutineContext, Element, CoroutineContext>() { // from class: kotlin.coroutines.experimental.CoroutineContext$plus$1
