        ...
        if (i >= tail) {
            if (i > tail) {
                for (int index = tail - 1; index >= 0; index--) {
                    if (Intrinsics.areEqual(element, this.elementData[index])) {
                        return (this.elementData.length + index) - this.head;
                    }
                }
