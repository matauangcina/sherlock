...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m1ln(double x) {
        return Math.log(x);
    }
    ...
    public static final int roundToInt(double $this$roundToInt) {
        ...
        if ($this$roundToInt > Integer.MAX_VALUE) {
            return Integer.MAX_VALUE;
        }
        if ($this$roundToInt < Integer.MIN_VALUE) {
    ...
    /* renamed from: ln */
    private static final float m0ln(float x) {
