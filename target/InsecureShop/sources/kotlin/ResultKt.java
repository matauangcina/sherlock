...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m53constructorimpl(function0.invoke());
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m53constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m53constructorimpl(function1.invoke(t));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m53constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m56exceptionOrNullimpl($this$getOrElse);
        if (exception == null) {
    ...
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R r) {
        return Result.m59isFailureimpl($this$getOrDefault) ? r : $this$getOrDefault;
    }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        Throwable exception = Result.m56exceptionOrNullimpl($this$fold);
        if (exception == null) {
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> function1) {
        if (Result.m60isSuccessimpl($this$map)) {
            Result.Companion companion = Result.Companion;
            return Result.m53constructorimpl(function1.invoke($this$map));
        }
        return Result.m53constructorimpl($this$map);
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> function1) {
        if (Result.m60isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.Companion;
                Object $this$runCatching = Result.m53constructorimpl(function1.invoke($this$mapCatching));
                return $this$runCatching;
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                return Result.m53constructorimpl(createFailure(th));
            }
        }
        return Result.m53constructorimpl($this$mapCatching);
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m56exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.Companion;
        return Result.m53constructorimpl(function1.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m56exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
            return $this$recoverCatching;
        }
        try {
            Result.Companion companion = Result.Companion;
            Object $this$runCatching = Result.m53constructorimpl(function1.invoke(exception));
            return $this$runCatching;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m53constructorimpl(createFailure(th));
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        Throwable it = Result.m56exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            function1.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> function1) {
        if (Result.m60isSuccessimpl($this$onSuccess)) {
