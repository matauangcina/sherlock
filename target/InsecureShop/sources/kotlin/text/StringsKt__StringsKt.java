            ...
            if (step2 < 0 ? index3 >= last3 : index3 <= last3) {
                while (true) {
                    ...
                    if (matchingString2 == null) {
                        ...
                        return TuplesKt.m12to(Integer.valueOf(index4), matchingString2);
                    }
                }
            }
        }
