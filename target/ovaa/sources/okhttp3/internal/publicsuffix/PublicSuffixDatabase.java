...
public final class PublicSuffixDatabase {
    ...
    public String getEffectiveTldPlusOne(String domain) {
        ...
        for (int i = firstLabelOffset; i < punycodeLabels.length; i++) {
            effectiveTldPlusOne.append(punycodeLabels[i]).append(FilenameUtils.EXTENSION_SEPARATOR);
        }
        ...
        while (low3 < high) {
            ...
            while (true) {
                if (expectDot) {
                    ...
                    byte0 = labels[currentLabelIndex][currentLabelByteIndex] & UByte.MAX_VALUE;
                }
                int byte1 = bytesToSearch[mid2 + publicSuffixByteIndex] & UByte.MAX_VALUE;
