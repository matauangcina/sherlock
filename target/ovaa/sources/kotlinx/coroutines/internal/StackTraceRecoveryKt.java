...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m210constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        try {
            ...
            obj2 = Result.m210constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m210constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m213exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
    ...
    private static final <E extends Throwable> Pair<E, StackTraceElement[]> causeAndStacktrace(E e) {
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            if (z) {
                return TuplesKt.m23to(cause, currentTrace);
            }
            return TuplesKt.m23to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m23to(e, new StackTraceElement[0]);
    }
