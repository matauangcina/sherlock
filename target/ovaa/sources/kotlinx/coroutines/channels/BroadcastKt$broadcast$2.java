...
@DebugMetadata(m22c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m21f = "Broadcast.kt", m20i = {0, 1}, m19l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_BASELINE_TO_BOTTOM_OF, ConstraintLayout.LayoutParams.Table.LAYOUT_MARGIN_BASELINE}, m18m = "invokeSuspend", m17n = {"$this$broadcast", "$this$broadcast"}, m16s = {"L$0", "L$0"})
