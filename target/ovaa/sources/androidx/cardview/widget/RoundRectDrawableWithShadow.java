...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C0124R.C0125color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0124R.C0125color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0124R.dimen.cardview_compat_inset_shadow);
    ...
    private void buildShadowCorners() {
        ...
        paint2.setShader(new LinearGradient(0.0f, (-f5) + f6, 0.0f, f7, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
