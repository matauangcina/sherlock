...
public class KeyTrigger extends Key {
    ...
    public void load(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.KeyTrigger);
    ...
    private static class Loader {
        ...
        static {
            ...
            mAttrMap.append(C0177R.styleable.KeyTrigger_viewTransitionOnCross, 12);
            mAttrMap.append(C0177R.styleable.KeyTrigger_viewTransitionOnNegativeCross, 13);
            mAttrMap.append(C0177R.styleable.KeyTrigger_viewTransitionOnPositiveCross, 14);
        }
