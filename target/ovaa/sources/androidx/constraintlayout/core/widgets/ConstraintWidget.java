...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f38mX + ", " + this.f39mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        switch (C01481.f40x6930e354[type.ordinal()]) {
            case 1:
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C01481.f40x6930e354[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C01481 {
    ...
    public void getSceneString(StringBuilder ret) {
        ...
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
        ret.append("    actualHeight:" + this.mHeight);
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
        ret.append("    actualLeft:" + this.f38mX);
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
        ret.append("    actualTop:" + this.f39mY);
        ret.append(IOUtils.LINE_SEPARATOR_UNIX);
