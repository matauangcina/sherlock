...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f85bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0;
                case 2:
                    return (int) FlexBuffers.readUInt(this.f85bb, this.end, this.parentWidth);
                case 3:
                    return (int) FlexBuffers.readDouble(this.f85bb, this.end, this.parentWidth);
                case 5:
                    return Integer.parseInt(asString());
                case 6:
                    ReadBuf readBuf = this.f85bb;
                    return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                case 7:
                    ReadBuf readBuf2 = this.f85bb;
                    return (int) FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
                case 8:
                    ReadBuf readBuf3 = this.f85bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f85bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0L;
                case 1:
                    return FlexBuffers.readLong(this.f85bb, this.end, this.parentWidth);
                case 3:
                    return (long) FlexBuffers.readDouble(this.f85bb, this.end, this.parentWidth);
                case 5:
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f85bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0.0d;
        ...
        public String asString() {
            if (isString()) {
                int start = FlexBuffers.indirect(this.f85bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f85bb;
                int i = this.byteWidth;
                int size = (int) FlexBuffers.readUInt(readBuf, start - i, i);
                return this.f85bb.getString(start, size);
            } else if (isKey()) {
                int start2 = FlexBuffers.indirect(this.f85bb, this.end, this.byteWidth);
                int i2 = start2;
                while (this.f85bb.get(i2) != 0) {
                    i2++;
                }
                return this.f85bb.getString(start2, i2 - start2);
            } else {
                return "";
            }
        }
        ...
        public boolean asBoolean() {
            return isBoolean() ? this.f85bb.get(this.end) != 0 : asUInt() != 0;
        }
    ...
    public static abstract class Sized extends Object {
        ...
        Sized(ReadBuf buff, int end, int byteWidth) {
            ...
            this.size = FlexBuffers.readInt(this.f84bb, end - byteWidth, byteWidth);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer dup = ByteBuffer.wrap(this.f84bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                result[i] = this.f84bb.get(this.end + i);
            }
            return result;
        }
        ...
        public byte get(int pos) {
            ...
            return this.f84bb.get(this.end + pos);
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public String toString() {
            return this.f84bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append(Typography.quote);
            sb.append(this.f84bb.getString(this.end, size()));
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f84bb, FlexBuffers.indirect(this.f84bb, keysOffset, this.byteWidth), FlexBuffers.readInt(this.f84bb, this.byteWidth + keysOffset, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f84bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int index) {
            ...
            int packedType = Unsigned.byteToUnsignedInt(this.f84bb.get((int) (this.end + (this.byteWidth * len) + index)));
            int obj_end = this.end + (this.byteWidth * index);
            return new Reference(this.f84bb, obj_end, this.byteWidth, packedType);
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int pos) {
            ...
            return new Reference(this.f84bb, childPos, this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int pos) {
            ...
            return new Key(this.vec.f84bb, FlexBuffers.indirect(this.vec.f84bb, childPos, this.vec.byteWidth), 1);
        }
