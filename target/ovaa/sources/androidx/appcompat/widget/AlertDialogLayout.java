    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0028R.C0031id.topPanel) {
                    topPanel = child;
                } else if (id == C0028R.C0031id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0028R.C0031id.contentPanel && id != C0028R.C0031id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
