...
public class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0028R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0028R.styleable.AlertDialog, C0028R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0028R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0028R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0028R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0028R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0028R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0028R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0028R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0028R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x009f, code lost:
        r1 = r9.findViewById(androidx.appcompat.C0028R.C0031id.titleDividerNoCustom);
     */
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0028R.C0031id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0028R.C0031id.scrollIndicatorDown);
    ...
    /* loaded from: classes.dex */
    class C00352 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00352(View view, View view2) {
            this.val$top = view;
    ...
    class RunnableC00363 implements Runnable {
        ...
        RunnableC00363(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class C00374 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00374(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    /* loaded from: classes.dex */
    class RunnableC00385 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00385(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0028R.C0031id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0028R.C0031id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0028R.C0031id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0028R.C0031id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0028R.C0031id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0028R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0028R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0028R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
