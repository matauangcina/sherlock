...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0306R.C0309id.fragment_container_view_tag);
    ...
    */
        ...
        if (!allowReordering2 && this.mCurState >= 1) {
            if (!USE_STATE_MANAGER) {
                ...
                for (int index = startIndex; index < endIndex; index++) {
                    Iterator<FragmentTransaction.C0362Op> it = records.get(index).mOps.iterator();
                    while (it.hasNext()) {
                        FragmentTransaction.C0362Op op = it.next();
            ...
            for (int index2 = startIndex; index2 < endIndex; index2++) {
                ...
                if (isPop) {
                    for (int opIndex = record2.mOps.size() - 1; opIndex >= 0; opIndex--) {
                        FragmentTransaction.C0362Op op2 = record2.mOps.get(opIndex);
                    ...
                    Iterator<FragmentTransaction.C0362Op> it2 = record2.mOps.iterator();
                    while (it2.hasNext()) {
                        FragmentTransaction.C0362Op op3 = it2.next();
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int index = startIndex; index < endIndex; index++) {
            ...
            Iterator<FragmentTransaction.C0362Op> it = record.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C0362Op op = it.next();
                Fragment fragment = op.mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment f) {
        ...
        if (container != null && f.getEnterAnim() + f.getExitAnim() + f.getPopEnterAnim() + f.getPopExitAnim() > 0) {
            if (container.getTag(C0306R.C0309id.visible_removing_fragment_view_tag) == null) {
                container.setTag(C0306R.C0309id.visible_removing_fragment_view_tag, f);
            }
            ((Fragment) container.getTag(C0306R.C0309id.visible_removing_fragment_view_tag)).setPopDirection(f.getPopDirection());
        }
    }
