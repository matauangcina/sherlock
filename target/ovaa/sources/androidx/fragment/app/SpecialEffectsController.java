...
public abstract class SpecialEffectsController {
    ...
    public static SpecialEffectsController getOrCreateController(ViewGroup container, SpecialEffectsControllerFactory factory) {
        Object controller = container.getTag(C0306R.C0309id.special_effects_controller_view_tag);
        ...
        container.setTag(C0306R.C0309id.special_effects_controller_view_tag, newController);
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            public void applyState(View view) {
                switch (C03813.f91xe493b431[ordinal()]) {
                    case 1:
        ...
        final void mergeWith(State finalState, LifecycleImpact lifecycleImpact) {
            switch (C03813.f90xb9e640f0[lifecycleImpact.ordinal()]) {
                case 1:
    ...
    public static /* synthetic */ class C03813 {
        ...
        static {
            ...
            try {
                f90xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f90xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f91xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f91xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f91xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
