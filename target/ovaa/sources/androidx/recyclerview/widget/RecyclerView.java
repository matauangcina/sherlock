...
import androidx.recyclerview.C0417R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0417R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0417R.styleable.RecyclerView, defStyleAttr, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0417R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0417R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0417R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0417R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = a.getBoolean(C0417R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            StateListDrawable verticalThumbDrawable = (StateListDrawable) a.getDrawable(C0417R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
            Drawable verticalTrackDrawable = a.getDrawable(C0417R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
            StateListDrawable horizontalThumbDrawable = (StateListDrawable) a.getDrawable(C0417R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
            Drawable horizontalTrackDrawable = a.getDrawable(C0417R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return RecyclerView.class.getPackage().getName() + FilenameUtils.EXTENSION_SEPARATOR + className;
    }
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0417R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0417R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0417R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0417R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0417R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0417R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0417R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0417R.dimen.fastscroll_margin));
    }
