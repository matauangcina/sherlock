...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0566R.attr.motionDurationMedium4, getResources().getInteger(C0566R.integer.material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0566R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
