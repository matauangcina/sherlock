...
public class MaterialResources {
    ...
    public static int getUnscaledTextSize(Context context, int textAppearance, int defValue) {
        ...
        TypedArray a = context.obtainStyledAttributes(textAppearance, C0566R.styleable.TextAppearance);
        TypedValue v = new TypedValue();
        boolean available = a.getValue(C0566R.styleable.TextAppearance_android_textSize, v);
        a.recycle();
        if (!available) {
            return defValue;
        }
