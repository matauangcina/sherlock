...
public class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0566R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray a = context.obtainStyledAttributes(attrs, C0566R.styleable.RadialViewGroup, defStyleAttr, 0);
        this.radius = a.getDimensionPixelSize(C0566R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    public void updateLayoutParams() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getId() != C0566R.C0569id.circle_center && !shouldSkipView(childAt)) {
                int level = (Integer) childAt.getTag(C0566R.C0569id.material_clock_level);
                if (level == null) {
                    level = 1;
                }
    ...
    private void addConstraints(List<View> views, ConstraintSet constraintSet, int leveledRadius) {
        ...
        for (View view : views) {
            constraintSet.constrainCircle(view.getId(), C0566R.C0569id.circle_center, leveledRadius, currentAngle);
