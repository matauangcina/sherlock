...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Chip chip = (Chip) inflater.inflate(C0566R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        chip.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout = (TextInputLayout) inflater.inflate(C0566R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0566R.C0569id.material_label);
