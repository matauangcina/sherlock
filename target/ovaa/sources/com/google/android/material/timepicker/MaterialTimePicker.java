...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, null, C0566R.attr.materialTimePickerStyle, C0566R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes(null, C0566R.styleable.MaterialTimePicker, C0566R.attr.materialTimePickerStyle, C0566R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C0566R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C0566R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int backgroundColor = a.getColor(C0566R.styleable.MaterialTimePicker_backgroundTint, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        TimePickerView timePickerView = (TimePickerView) root.findViewById(C0566R.C0569id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) root.findViewById(C0566R.C0569id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C0566R.C0569id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C0566R.C0569id.header_title);
        ...
        Button okButton = (Button) root.findViewById(C0566R.C0569id.material_timepicker_ok_button);
        ...
        Button button = (Button) root.findViewById(C0566R.C0569id.material_timepicker_cancel_button);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.this.m35xac73da03();
                }
            }, 100L);
        }
    }
    ...
    public /* synthetic */ void m35xac73da03() {
        TimePickerPresenter timePickerPresenter = this.activePresenter;
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0566R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0566R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C0566R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;
