...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0566R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0566R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L2e:
            ...
            int[] r2 = com.google.android.material.C0566R.styleable.AppBarLayout
            int[] r5 = new int[r7]
            r0 = r10
            r1 = r11
            r3 = r12
            android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r1 = com.google.android.material.C0566R.styleable.AppBarLayout_android_background
            android.graphics.drawable.Drawable r1 = r0.getDrawable(r1)
            androidx.core.view.ViewCompat.setBackground(r9, r1)
            int r1 = com.google.android.material.C0566R.styleable.AppBarLayout_liftOnScrollColor
        ...
        L6c:
            int r3 = com.google.android.material.C0566R.attr.motionDurationMedium2
            android.content.res.Resources r4 = r9.getResources()
            int r5 = com.google.android.material.C0566R.integer.app_bar_elevation_anim_duration
            int r4 = r4.getInteger(r5)
            int r3 = com.google.android.material.motion.MotionUtils.resolveThemeDuration(r10, r3, r4)
            long r3 = (long) r3
            r9.liftOnScrollColorDuration = r3
            int r3 = com.google.android.material.C0566R.attr.motionEasingStandardInterpolator
            ...
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_expanded
        ...
        L9a:
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_elevation
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lac
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_elevation
        ...
        Lac:
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lbe
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r3 = r0.getBoolean(r3, r7)
        ...
        Lbe:
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r3 = r0.hasValue(r3)
            if (r3 == 0) goto Lcf
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r3 = r0.getBoolean(r3, r7)
        ...
        Lcf:
            ...
            int r4 = com.google.android.material.C0566R.dimen.design_appbar_elevation
            float r3 = r3.getDimension(r4)
            r9.appBarElevation = r3
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_liftOnScroll
            boolean r3 = r0.getBoolean(r3, r7)
            r9.liftOnScroll = r3
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r3 = r0.getResourceId(r3, r6)
            r9.liftOnScrollTargetViewId = r3
            int r3 = com.google.android.material.C0566R.styleable.AppBarLayout_statusBarForeground
    ...
    private void initializeLiftOnScrollWithColor(final MaterialShapeDrawable background, final ColorStateList originalBackgroundColor, final ColorStateList liftOnScrollColor) {
        final Integer colorSurface = MaterialColors.getColorOrNull(getContext(), C0566R.attr.colorSurface);
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m123x91f594d8(originalBackgroundColor, liftOnScrollColor, background, colorSurface, valueAnimator);
            }
        };
    ...
    public /* synthetic */ void m123x91f594d8(ColorStateList originalBackgroundColor, ColorStateList liftOnScrollColor, MaterialShapeDrawable background, Integer colorSurface, ValueAnimator valueAnimator) {
        Integer num;
    ...
    private void initializeLiftOnScrollWithElevation(Context context, final MaterialShapeDrawable background) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.this.m122x84b6053(background, valueAnimator);
            }
        };
        ViewCompat.setBackground(this, background);
    }
    ...
    public /* synthetic */ void m122x84b6053(MaterialShapeDrawable background, ValueAnimator valueAnimator) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0566R.attr.state_liftable : -C0566R.attr.state_liftable;
        extraStates[1] = (this.liftable && this.lifted) ? C0566R.attr.state_lifted : -C0566R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0566R.attr.state_collapsible : -C0566R.attr.state_collapsible;
        extraStates[3] = (this.liftable && this.lifted) ? C0566R.attr.state_collapsed : -C0566R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.scrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0566R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0566R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int scrollEffectInt = a.getInt(C0566R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0);
            setScrollEffect(scrollEffectInt);
            if (a.hasValue(C0566R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0566R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0566R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0566R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
