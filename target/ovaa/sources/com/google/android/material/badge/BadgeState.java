...
public final class BadgeState {
    ...
    public BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        this.badgeRadius = a.getDimensionPixelSize(C0566R.styleable.Badge_badgeRadius, -1);
        this.horizontalInset = context.getResources().getDimensionPixelSize(C0566R.dimen.mtrl_badge_horizontal_edge_offset);
        this.horizontalInsetWithText = context.getResources().getDimensionPixelSize(C0566R.dimen.mtrl_badge_text_horizontal_edge_offset);
        this.badgeWithTextRadius = a.getDimensionPixelSize(C0566R.styleable.Badge_badgeWithTextRadius, -1);
        this.badgeWidth = a.getDimension(C0566R.styleable.Badge_badgeWidth, res.getDimension(C0566R.dimen.m3_badge_size));
        this.badgeWithTextWidth = a.getDimension(C0566R.styleable.Badge_badgeWithTextWidth, res.getDimension(C0566R.dimen.m3_badge_with_text_size));
        this.badgeHeight = a.getDimension(C0566R.styleable.Badge_badgeHeight, res.getDimension(C0566R.dimen.m3_badge_size));
        this.badgeWithTextHeight = a.getDimension(C0566R.styleable.Badge_badgeWithTextHeight, res.getDimension(C0566R.dimen.m3_badge_with_text_size));
        boolean z = true;
        this.offsetAlignmentMode = a.getInt(C0566R.styleable.Badge_offsetAlignmentMode, 1);
        state.alpha = storedState.alpha == -2 ? 255 : storedState.alpha;
        if (storedState.number == -2) {
            if (a.hasValue(C0566R.styleable.Badge_number)) {
                state.number = a.getInt(C0566R.styleable.Badge_number, 0);
            } else {
                state.number = -1;
            }
        } else {
        ...
        if (storedState.text == null) {
            if (a.hasValue(C0566R.styleable.Badge_badgeText)) {
                state.text = a.getString(C0566R.styleable.Badge_badgeText);
            }
        } else {
        ...
        if (storedState.contentDescriptionNumberless == null) {
            charSequence = context.getString(C0566R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (storedState.contentDescriptionQuantityStrings == 0) {
            i = C0566R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (storedState.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i2 = C0566R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (storedState.maxCharacterCount == -2) {
            i3 = a.getInt(C0566R.styleable.Badge_maxCharacterCount, -2);
        } else {
            i3 = storedState.maxCharacterCount;
        }
        state.maxCharacterCount = i3;
        if (storedState.maxNumber == -2) {
            i4 = a.getInt(C0566R.styleable.Badge_maxNumber, -2);
        } else {
            i4 = storedState.maxNumber;
        }
        state.maxNumber = i4;
        if (storedState.badgeShapeAppearanceResId == null) {
            intValue = a.getResourceId(C0566R.styleable.Badge_badgeShapeAppearance, C0566R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (storedState.badgeShapeAppearanceOverlayResId == null) {
            intValue2 = a.getResourceId(C0566R.styleable.Badge_badgeShapeAppearanceOverlay, 0);
        } else {
        ...
        if (storedState.badgeWithTextShapeAppearanceResId == null) {
            intValue3 = a.getResourceId(C0566R.styleable.Badge_badgeWithTextShapeAppearance, C0566R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (storedState.badgeWithTextShapeAppearanceOverlayResId == null) {
            intValue4 = a.getResourceId(C0566R.styleable.Badge_badgeWithTextShapeAppearanceOverlay, 0);
        } else {
        ...
        if (storedState.backgroundColor == null) {
            intValue5 = readColorFromAttributes(context, a, C0566R.styleable.Badge_backgroundColor);
        } else {
        ...
        if (storedState.badgeTextAppearanceResId == null) {
            intValue6 = a.getResourceId(C0566R.styleable.Badge_badgeTextAppearance, C0566R.style.TextAppearance_MaterialComponents_Badge);
        } else {
        ...
        if (storedState.badgeTextColor == null) {
            if (!a.hasValue(C0566R.styleable.Badge_badgeTextColor)) {
                ...
                state.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, a, C0566R.styleable.Badge_badgeTextColor));
            }
        } else {
            state.badgeTextColor = storedState.badgeTextColor;
        }
        if (storedState.badgeGravity == null) {
            intValue7 = a.getInt(C0566R.styleable.Badge_badgeGravity, 8388661);
        } else {
        ...
        if (storedState.badgeHorizontalPadding == null) {
            intValue8 = a.getDimensionPixelSize(C0566R.styleable.Badge_badgeWidePadding, res.getDimensionPixelSize(C0566R.dimen.mtrl_badge_long_text_horizontal_padding));
        } else {
        ...
        if (storedState.badgeVerticalPadding == null) {
            intValue9 = a.getDimensionPixelSize(C0566R.styleable.Badge_badgeVerticalPadding, res.getDimensionPixelSize(C0566R.dimen.m3_badge_with_text_vertical_padding));
        } else {
        ...
        if (storedState.horizontalOffsetWithoutText == null) {
            intValue10 = a.getDimensionPixelOffset(C0566R.styleable.Badge_horizontalOffset, 0);
        } else {
        ...
        if (storedState.verticalOffsetWithoutText == null) {
            intValue11 = a.getDimensionPixelOffset(C0566R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (storedState.horizontalOffsetWithText == null) {
            intValue12 = a.getDimensionPixelOffset(C0566R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.verticalOffsetWithText == null) {
            intValue13 = a.getDimensionPixelOffset(C0566R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
        ...
        if (storedState.largeFontVerticalOffsetAdjustment == null) {
            intValue14 = a.getDimensionPixelOffset(C0566R.styleable.Badge_largeFontVerticalOffsetAdjustment, 0);
        } else {
        ...
        if (storedState.autoAdjustToWithinGrandparentBounds == null) {
            booleanValue = a.getBoolean(C0566R.styleable.Badge_autoAdjustToWithinGrandparentBounds, false);
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int badgeResId, int defStyleAttr, int defStyleRes) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attrs, C0566R.styleable.Badge, defStyleAttr, style, new int[0]);
    }
