...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int colorToHarmonize) {
        return harmonize(colorToHarmonize, getColor(context, C0566R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C0566R.attr.isLightTheme, true);
    }
