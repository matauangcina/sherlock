...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean expand) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.internal.ExpandCollapseAnimationHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ExpandCollapseAnimationHelper.this.m71xeb41e2ac(bounds, valueAnimator);
            }
        });
        ...
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m70of(expand, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animator;
    }
    ...
    public /* synthetic */ void m71xeb41e2ac(Rect bounds, ValueAnimator valueAnimator) {
    ...
    private Animator getExpandedViewChildrenAlphaAnimator(boolean expand) {
        ...
        animator.setDuration(this.duration);
        animator.setInterpolator(ReversableAnimatedValueInterpolator.m70of(expand, AnimationUtils.LINEAR_INTERPOLATOR));
        return animator;
    }
