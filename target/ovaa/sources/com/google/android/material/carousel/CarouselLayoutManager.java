...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public /* synthetic */ void m119x2ff337cb(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
    ...
    public CarouselLayoutManager(CarouselStrategy strategy, int orientation) {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda1
            ...
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                CarouselLayoutManager.this.m119x2ff337cb(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        };
    ...
    private void setCarouselAttributes(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0566R.styleable.Carousel);
            setCarouselAlignment(a.getInt(C0566R.styleable.Carousel_carousel_alignment, 0));
            setOrientation(a.getInt(C0566R.styleable.RecyclerView_android_orientation, 0));
            a.recycle();
        }
    }
    ...
    public static class DebugItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
            ...
            this.linePaint.setStrokeWidth(parent.getResources().getDimension(C0566R.dimen.m3_carousel_debug_keyline_width));
