...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0566R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0566R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0566R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, C0566R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray a = context2.obtainStyledAttributes(null, C0566R.styleable.MaterialAlertDialog, i, i2);
        int backgroundColor = a.getColor(C0566R.styleable.MaterialAlertDialog_backgroundTint, surfaceColor);
        a.recycle();
