...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int DEF_STYLE_RES = C0566R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0566R.attr.textInputStyle);
    }
    ...
    */
        ...
        if (updatedHeight || updatedIcon) {
            this.editText.post(new Runnable() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    TextInputLayout.this.m37xa47602b9();
                }
            });
        }
    }
    ...
    public /* synthetic */ void m37xa47602b9() {
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int rippleColor = MaterialColors.getColor(this.editText, C0566R.attr.colorControlHighlight);
        int i = this.boxBackgroundMode;
        if (i == 2) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable boxBackground, int rippleColor, int[][] states) {
        int surfaceColor = MaterialColors.getColor(context, C0566R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean roundedTopCorners) {
        float elevation;
        float cornerRadius = getResources().getDimensionPixelOffset(C0566R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            elevation = getResources().getDimensionPixelOffset(C0566R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int verticalPadding = getResources().getDimensionPixelOffset(C0566R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0566R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C0566R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText = this.editText;
            ViewCompat.setPaddingRelative(editText, ViewCompat.getPaddingStart(editText), getResources().getDimensionPixelSize(C0566R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0566R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText2 = this.editText;
            ViewCompat.setPaddingRelative(editText2, ViewCompat.getPaddingStart(editText2), getResources().getDimensionPixelSize(C0566R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C0566R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.counterEnabled != enabled) {
            if (!enabled) {
                ...
                appCompatTextView.setId(C0566R.C0569id.textinput_counter);
                ...
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C0566R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable text) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(bidiFormatter.unicodeWrap(getContext().getString(C0566R.string.character_counter_pattern, Integer.valueOf(length), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView counterView, int length, int counterMaxLength, boolean counterOverflowed) {
        ...
        if (counterOverflowed) {
            i = C0566R.string.character_counter_overflowed_content_description;
        } else {
            i = C0566R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence placeholderText) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C0566R.C0569id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        ...
        placeholderFadeTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0566R.attr.motionDurationShort2, DEFAULT_PLACEHOLDER_FADE_DURATION));
        placeholderFadeTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0566R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
    ...
    public void setTextAppearanceCompatWithErrorFallback(TextView textView, int textAppearance) {
        ...
        if (useDefaultColor) {
            TextViewCompat.setTextAppearance(textView, C0566R.style.TextAppearance_AppCompat_Caption);
            textView.setTextColor(ContextCompat.getColor(getContext(), C0566R.C0567color.design_error));
        }
    }
    ...
    private int calculateBoxBackgroundColor() {
        ...
        if (this.boxBackgroundMode == 1) {
            int surfaceLayerColor = MaterialColors.getColor(this, C0566R.attr.colorSurface, 0);
    ...
    private void updateCursorColor() {
        ...
        if (color == null) {
            color = MaterialColors.getColorStateListOrNull(getContext(), C0566R.attr.colorControlActivated);
        }
        EditText editText = this.editText;
    ...
    void animateToExpansionFraction(float target) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0566R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0566R.attr.motionDurationMedium4, LABEL_SCALE_ANIMATION_DURATION));
