...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C0566R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C0566R.attr.state_indeterminate};
    private static final int[] ERROR_STATE_SET = {C0566R.attr.state_error};
    private static final int[][] CHECKBOX_STATES = {new int[]{16842910, C0566R.attr.state_error}, new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, C0566R.attr.checkboxStyle);
    }
    ...
    */
    public MaterialCheckBox(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            int r1 = com.google.android.material.C0566R.C0568drawable.mtrl_checkbox_button_checked_unchecked
            ...
            int[] r2 = com.google.android.material.C0566R.styleable.MaterialCheckBox
            r7 = 0
            int[] r5 = new int[r7]
            r0 = r9
            r1 = r10
            ...
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_buttonIcon
            ...
            int r1 = com.google.android.material.C0566R.C0568drawable.mtrl_checkbox_button
            ...
            if (r1 != 0) goto L7d
            int r1 = com.google.android.material.C0566R.C0568drawable.mtrl_checkbox_button_icon
            android.graphics.drawable.Drawable r1 = androidx.appcompat.content.res.AppCompatResources.getDrawable(r9, r1)
            r8.buttonIconDrawable = r1
        L7d:
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_buttonIconTint
            ...
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_buttonIconTintMode
            r3 = -1
            ...
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_useMaterialThemeColors
            boolean r1 = r0.getBoolean(r1, r7)
            r8.useMaterialThemeColors = r1
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_centerIfNoTextEnabled
            boolean r1 = r0.getBoolean(r1, r2)
            r8.centerIfNoTextEnabled = r1
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_errorShown
            boolean r1 = r0.getBoolean(r1, r7)
            r8.errorShown = r1
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_errorAccessibilityLabel
            java.lang.CharSequence r1 = r0.getText(r1)
            r8.errorAccessibilityLabel = r1
            int r1 = com.google.android.material.C0566R.styleable.MaterialCheckBox_checkedState
    ...
    public /* synthetic */ void m117xdf87d0bf() {
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        ...
        if ((drawable instanceof AnimatedStateListDrawable) && this.transitionToUnchecked != null) {
            ((AnimatedStateListDrawable) drawable).addTransition(C0566R.C0569id.checked, C0566R.C0569id.unchecked, this.transitionToUnchecked, false);
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C0566R.C0569id.indeterminate, C0566R.C0569id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private String getButtonStateDescription() {
        ...
        if (i == 1) {
            return getResources().getString(C0566R.string.mtrl_checkbox_state_description_checked);
        }
        if (i == 0) {
            return getResources().getString(C0566R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C0566R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray attributes) {
        int buttonResourceId = attributes.getResourceId(C0566R.styleable.MaterialCheckBox_android_button, 0);
        int buttonCompatResourceId = attributes.getResourceId(C0566R.styleable.MaterialCheckBox_buttonCompat, 0);
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int colorControlActivated = MaterialColors.getColor(this, C0566R.attr.colorControlActivated);
            int colorError = MaterialColors.getColor(this, C0566R.attr.colorError);
            int colorSurface = MaterialColors.getColor(this, C0566R.attr.colorSurface);
            int colorOnSurface = MaterialColors.getColor(this, C0566R.attr.colorOnSurface);
