...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C1162R.layout.activity_login);
        LoginUtils loginUtils = LoginUtils.getInstance(this);
        this.loginUtils = loginUtils;
        if (loginUtils.isLoggedIn()) {
            onLoginFinished();
        } else {
            findViewById(C1162R.C1165id.loginButton).setOnClickListener(new View.OnClickListener() { // from class: oversecured.ovaa.activities.LoginActivity.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    String email = ((TextView) LoginActivity.this.findViewById(C1162R.C1165id.emailView)).getText().toString();
                    String password = ((TextView) LoginActivity.this.findViewById(C1162R.C1165id.passwordView)).getText().toString();
