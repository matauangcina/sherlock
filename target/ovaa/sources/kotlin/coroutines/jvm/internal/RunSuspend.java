...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1427getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m209boximpl(result);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m219unboximpl());
                }
            }
        }
    }
