...
import sherlock.benchmark.database.User;
import sherlock.benchmark.database.UserLab;
import sherlock.benchmark.insecure_broadcast.InsufficientProtectionActivity;
import sherlock.benchmark.mutable_pending_intent.NotificationActivity;
import sherlock.benchmark.unsafe_intent_uri.webview.BasicActivity;
import sherlock.benchmark.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.insecureSetResultBasic.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.insecure_set_result.BasicActivity.newIntent(this, INSECURE_SET_RESULT);
            startActivity(i);
        });

        binding.insecureSetResultImplicit.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.insecure_set_result.ImplicitIntentActivity.newIntent(this, INSECURE_SET_RESULT);
            startActivity(i);
        });

        binding.intentRedirectionBasic.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.intent_redirection.BasicActivity.newIntent(this, INTENT_REDIRECTION);
            startActivity(i);
        });

        binding.intentRedirectionImplicit.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.intent_redirection.ImplicitIntentActivity.newIntent(this, INTENT_REDIRECTION);
            startActivity(i);
        });

        binding.unsafeIntentUriBasic.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.unsafe_intent_uri.component.BasicActivity.newIntent(this, UNSAFE_INTENT_URI);
            startActivity(i);
        });
        ...
        binding.mutablePendingIntentBasic.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.mutable_pending_intent.BasicActivity.newIntent(this, MUTABLE_PENDING_INTENT);
            startActivity(i);
        });
        ...
        binding.insecureBroadcastBasic.setOnClickListener(v1 -> {
            Intent i = sherlock.benchmark.insecure_broadcast.BasicActivity.newIntent(this, INSECURE_BROADCAST);
            startActivity(i);
        });
