package sherlock.benchmark.unsafe_intent_uri.webview;
...
import sherlock.benchmark.databinding.ActivityUnsafeIntentWebviewBinding;
...
public class BasicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.basicTwoSafe.setOnClickListener(v1 -> {
            Toast.makeText(
                    this,
                    "Load sherlock.test.webview_intent_uri.BasicDeeplinkActivity with: sherlock://webview.intent.uri.basic.deeplink/filtered",
                    Toast.LENGTH_LONG
            ).show();
        });
