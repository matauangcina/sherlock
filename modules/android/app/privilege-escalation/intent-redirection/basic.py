    ...
    def register_options(self):
        ...
        option_state.add_options({
            "exploit": [
                ...
                OptStr("PARCEL_EXTRA", [True, "Parcel extra key"]),
                OptStr("BUNDLE_EXTRA", [False, "Bundle extra key"]),
                OptStr("BUNDLE_PARCEL", [False, "Parcel key in bundle"]),
        ...
        exploit_activity = self._template.build_activity(
            ...
            on_create=[
                self._template.build_intent(
                    ...
                    put_extra=[[extra[0], f'"{extra[1]}"'] for extra in protected_component_extra] if not leak_provider and protected_component_extra != "" else [],
