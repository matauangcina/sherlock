...
class SherlockModule(App):
    ...
    def register_options(self):
        ...
        option_state.add_options({
            ...
            "dynamic_receiver": [
                OptStr("INTENT_FILTER", [True, "Broadcast action to intercept"]),
                OptStr("BUNDLE_EXTRA", [False, "Bundle extra key"]),
                OptList("BUNDLE_STRING", [False, "String bundle key to sniff (Usage: <key>;<key>;..)"]),
                OptList("BPUT_EXTRA", [True, "Target broadcast intent extra key to sniff (Usage: <key>;<key>;..)"])
            ]
        })
    ...
    def execute(self):
        ...
        broadcast_extra = opts['BPUT_EXTRA']
